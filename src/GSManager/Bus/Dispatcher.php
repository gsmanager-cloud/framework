...
use GSManager\Queue\Jobs\SyncJob;
...
class Dispatcher implements QueueingDispatcher
{
     ...
     *
     * @var \GSManager\Pipeline\Pipeline
     */
    protected $pipeline;
     ...
     *
     * @param  \GSManager\Support\Collection|array|mixed  $jobs
     ...
     *
     * @param  \GSManager\Contracts\Queue\Queue  $queue
     * @param  mixed  $command
     * @return mixed
     */
