 ...
 *
 * @mixin \GSManager\Support\Collection<TKey, TValue>
 */
abstract class AbstractCursorPaginator implements Htmlable, Stringable
{
     ...
     *
     * @var \GSManager\Support\Collection<TKey, TValue>
     */
    protected $items;
     ...
     * The current cursor.
     *
     * @var \GSManager\Pagination\Cursor|null
     */
    protected $cursor;
     ...
     *
     * @param  \GSManager\Pagination\Cursor|null  $cursor
     * @return string
     */
     ...
     *
     * @return \GSManager\Pagination\Cursor|null
     */
     ...
     * @param  bool  $isNext
     * @return \GSManager\Pagination\Cursor
     */
     ...
     * @template TSetValue
     *
     * @param  \GSManager\Support\Collection<TSetKey, TSetValue>  $collection
     * @return $this
     *
