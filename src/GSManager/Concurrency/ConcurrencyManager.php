...
use GSManager\Support\MultipleInstanceManager;
use RuntimeException;
use GSManager\Fork\Fork;

/**
 * @mixin \GSManager\Contracts\Concurrency\Driver
 */
class ConcurrencyManager extends MultipleInstanceManager
{
     ...
     *
     * @param  array  $config
     * @return \GSManager\Concurrency\ProcessDriver
     */
     ...
     *
     * @param  array  $config
     * @return \GSManager\Concurrency\ForkDriver
     *
     ...
     *
     * @param  array  $config
     * @return \GSManager\Concurrency\SyncDriver
     */
