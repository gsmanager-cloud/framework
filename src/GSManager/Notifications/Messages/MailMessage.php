...
namespace GSManager\Notifications\Messages;
...
class MailMessage extends SimpleMessage implements Renderable
{
     ...
     *
     * @param  array<string|\GSManager\Contracts\Mail\Attachable|\GSManager\Mail\Attachment|array>  $files
     * @return $this
     */
