...
class EncodedHtmlString extends HtmlString
{
     ...
     * The HTML string.
     *
     * @var \GSManager\Contracts\Support\DeferringDisplayableValue|\GSManager\Contracts\Support\Htmlable|\BackedEnum|string|int|float|null
     */
    protected $html;
     ...
     *
     * @param  \GSManager\Contracts\Support\DeferringDisplayableValue|\GSManager\Contracts\Support\Htmlable|\BackedEnum|string|int|float|null  $html
