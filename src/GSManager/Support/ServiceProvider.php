...
use GSManager\Database\Eloquent\Factory as ModelFactory;
...
abstract class ServiceProvider
{
    ...
    public function commands($commands)
    {
        ...
        Artisan::starting(function ($gsm) use ($commands) {
            $gsm->resolveCommands($commands);
        });
    }
    ...
    /**
     * Get the default providers for a GSManager application.
     *
     * @return \GSManager\Support\DefaultProviders
     */
