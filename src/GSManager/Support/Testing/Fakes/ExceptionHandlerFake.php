...
use GSManager\Foundation\Testing\Concerns\WithoutExceptionHandlingHandler;
...
/**
 * @mixin \GSManager\Foundation\Exceptions\Handler
 */
class ExceptionHandlerFake implements ExceptionHandler, Fake
{
     ...
     *
     * @return \GSManager\Contracts\Debug\ExceptionHandler
     */
