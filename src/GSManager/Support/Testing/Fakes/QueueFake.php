...
use Closure;
use GSManager\Contracts\Queue\Queue;
use GSManager\Events\CallQueuedListener;
use GSManager\Queue\CallQueuedClosure;
use GSManager\Queue\QueueManager;
...
class QueueFake extends QueueManager implements Fake, Queue
{
     ...
     *
     * @var \GSManager\Contracts\Queue\Queue
     */
    public $queue;
     ...
     * @param  \GSManager\Queue\QueueManager|null  $queue
     */
     ...
     * @return \GSManager\Support\Collection<int, RawPushType>
     */
     ...
     * @param  (\Closure(mixed, \GSManager\Events\CallQueuedListener, string|null, mixed): bool)|null  $callback
     * @return \GSManager\Support\Collection<int, \GSManager\Events\CallQueuedListener>
     */
