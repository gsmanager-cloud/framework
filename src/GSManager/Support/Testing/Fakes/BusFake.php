...
use GSManager\Bus\ChainedBatch;
use GSManager\Bus\PendingBatch;
use GSManager\Contracts\Bus\QueueingDispatcher;
...
class BusFake implements Fake, QueueingDispatcher
{
     ...
     *
     * @var \GSManager\Contracts\Bus\QueueingDispatcher
     */
    public $dispatcher;
     ...
     *
     * @var \GSManager\Bus\BatchRepository
     */
     ...
     *
     * @param  \GSManager\Contracts\Bus\QueueingDispatcher  $dispatcher
     ...
     * @return \GSManager\Support\Testing\Fakes\ChainedBatchTruthTest
     */
     ...
     *
     * @param  \GSManager\Support\Collection|array  $jobs
     * @return \GSManager\Foundation\Bus\PendingChain
     */
     ...
     * @return \GSManager\Bus\Batch|null
     */
     ...
     *
     * @param  \GSManager\Bus\PendingBatch  $pendingBatch
     * @return \GSManager\Bus\Batch
     */
