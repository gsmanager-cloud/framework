 ...
 * @method \GSManager\Support\Carbon|null create($year = 0, $month = 1, $day = 1, $hour = 0, $minute = 0, $second = 0, $timezone = null)
 * @method \GSManager\Support\Carbon createFromDate($year = null, $month = null, $day = null, $timezone = null)
 * @method \GSManager\Support\Carbon|null createFromFormat($format, $time, $timezone = null)
 * @method \GSManager\Support\Carbon|null createFromIsoFormat(string $format, string $time, $timezone = null, ?string $locale = 'en', ?\Symfony\Contracts\Translation\TranslatorInterface $translator = null)
 * @method \GSManager\Support\Carbon|null createFromLocaleFormat(string $format, string $locale, string $time, $timezone = null)
 * @method \GSManager\Support\Carbon|null createFromLocaleIsoFormat(string $format, string $locale, string $time, $timezone = null)
 * @method \GSManager\Support\Carbon createFromTime($hour = 0, $minute = 0, $second = 0, $timezone = null)
 * @method \GSManager\Support\Carbon createFromTimeString(string $time, \DateTimeZone|string|int|null $timezone = null)
 * @method \GSManager\Support\Carbon createFromTimestamp(string|int|float $timestamp, \DateTimeZone|string|int|null $timezone = null)
 * @method \GSManager\Support\Carbon createFromTimestampMs(string|int|float $timestamp, \DateTimeZone|string|int|null $timezone = null)
 * @method \GSManager\Support\Carbon createFromTimestampMsUTC($timestamp)
 * @method \GSManager\Support\Carbon createFromTimestampUTC(string|int|float $timestamp)
 * @method \GSManager\Support\Carbon createMidnightDate($year = null, $month = null, $day = null, $timezone = null)
 * @method \GSManager\Support\Carbon|null createSafe($year = null, $month = null, $day = null, $hour = null, $minute = null, $second = null, $timezone = null)
 * @method \GSManager\Support\Carbon createStrict(?int $year = 0, ?int $month = 1, ?int $day = 1, ?int $hour = 0, ?int $minute = 0, ?int $second = 0, $timezone = null)
 ...
 * @method \GSManager\Support\Carbon fromSerialized($value)
 ...
 * @method \GSManager\Support\Carbon|null getTestNow()
 ...
 * @method \GSManager\Support\Carbon instance(\DateTimeInterface $date)
 ...
 * @method \GSManager\Support\Carbon|null make($var, \DateTimeZone|string|null $timezone = null)
 * @method void mixin(object|string $mixin)
 * @method \GSManager\Support\Carbon now(\DateTimeZone|string|int|null $timezone = null)
 * @method \GSManager\Support\Carbon parse(\DateTimeInterface|\Carbon\WeekDay|\Carbon\Month|string|int|float|null $time, \DateTimeZone|string|int|null $timezone = null)
 * @method \GSManager\Support\Carbon parseFromLocale(string $time, ?string $locale = null, \DateTimeZone|string|int|null $timezone = null)
 * @method string pluralUnit(string $unit)
 * @method \GSManager\Support\Carbon|null rawCreateFromFormat(string $format, string $time, $timezone = null)
 * @method \GSManager\Support\Carbon rawParse(\DateTimeInterface|\Carbon\WeekDay|\Carbon\Month|string|int|float|null $time, \DateTimeZone|string|int|null $timezone = null)
 ...
 * @method \GSManager\Support\Carbon today(\DateTimeZone|string|int|null $timezone = null)
 * @method \GSManager\Support\Carbon tomorrow(\DateTimeZone|string|int|null $timezone = null)
 ...
 * @method \GSManager\Support\Carbon yesterday(\DateTimeZone|string|int|null $timezone = null)
 */
class DateFactory
{
    /**
