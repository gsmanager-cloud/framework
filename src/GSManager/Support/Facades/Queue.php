...
use GSManager\Queue\Worker;
use GSManager\Support\Testing\Fakes\QueueFake;
 ...
 * @method static \GSManager\Contracts\Queue\Queue connection(string|null $name = null)
 ...
 * @method static \GSManager\Queue\QueueManager setApplication(\GSManager\Contracts\Foundation\Application $app)
 ...
 * @method static \GSManager\Contracts\Queue\Job|null pop(string|null $queue = null)
 * @method static string getConnectionName()
 * @method static \GSManager\Contracts\Queue\Queue setConnectionName(string $name)
 ...
 * @method static \GSManager\Container\Container getContainer()
 * @method static void setContainer(\GSManager\Container\Container $container)
 * @method static \GSManager\Support\Testing\Fakes\QueueFake except(array|string $jobsToBeQueued)
 ...
 * @method static \GSManager\Support\Collection pushed(string $job, callable|null $callback = null)
 * @method static \GSManager\Support\Collection pushedRaw(null|\Closure $callback = null)
 * @method static \GSManager\Support\Collection listenersPushed(string $listenerClass, \Closure|null $callback = null)
 ...
 * @method static \GSManager\Support\Testing\Fakes\QueueFake serializeAndRestore(bool $serializeAndRestore = true)
 *
 * @see \GSManager\Queue\QueueManager
 * @see \GSManager\Queue\Queue
 * @see \GSManager\Support\Testing\Fakes\QueueFake
 */
class Queue extends Facade
{
     ...
     * @return \GSManager\Support\Testing\Fakes\QueueFake
     */
