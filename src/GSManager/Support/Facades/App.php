...
/**
 * @method static \GSManager\Foundation\Configuration\ApplicationBuilder configure(string|null $basePath = null)
 ...
 * @method static \GSManager\Foundation\Application setBasePath(string $basePath)
 * @method static string path(string $path = '')
 * @method static \GSManager\Foundation\Application useAppPath(string $path)
 * @method static string basePath(string $path = '')
 * @method static string bootstrapPath(string $path = '')
 * @method static string getBootstrapProvidersPath()
 * @method static \GSManager\Foundation\Application useBootstrapPath(string $path)
 * @method static string configPath(string $path = '')
 * @method static \GSManager\Foundation\Application useConfigPath(string $path)
 * @method static string databasePath(string $path = '')
 * @method static \GSManager\Foundation\Application useDatabasePath(string $path)
 * @method static string langPath(string $path = '')
 * @method static \GSManager\Foundation\Application useLangPath(string $path)
 * @method static string publicPath(string $path = '')
 * @method static \GSManager\Foundation\Application usePublicPath(string $path)
 * @method static string storagePath(string $path = '')
 * @method static \GSManager\Foundation\Application useStoragePath(string $path)
 * @method static string resourcePath(string $path = '')
 * @method static string viewPath(string $path = '')
 * @method static string joinPaths(string $basePath, string $path = '')
 * @method static string environmentPath()
 * @method static \GSManager\Foundation\Application useEnvironmentPath(string $path)
 * @method static \GSManager\Foundation\Application loadEnvironmentFrom(string $file)
 ...
 * @method static \GSManager\Support\ServiceProvider register(\GSManager\Support\ServiceProvider|string $provider, bool $force = false)
 * @method static \GSManager\Support\ServiceProvider|null getProvider(\GSManager\Support\ServiceProvider|string $provider)
 * @method static array getProviders(\GSManager\Support\ServiceProvider|string $provider)
 * @method static \GSManager\Support\ServiceProvider resolveProvider(string $provider)
 ...
 * @method static void handleRequest(\GSManager\Http\Request $request)
 ...
 * @method static \GSManager\Foundation\Application dontMergeFrameworkConfiguration()
 ...
 * @method static \GSManager\Foundation\Application addAbsoluteCachePathPrefix(string $prefix)
 * @method static \GSManager\Contracts\Foundation\MaintenanceMode maintenanceMode()
 * @method static bool isDownForMaintenance()
 * @method static never abort(int $code, string $message = '', array $headers = [])
 * @method static \GSManager\Foundation\Application terminating(callable|string $callback)
 ...
 * @method static \GSManager\Contracts\Container\ContextualBindingBuilder when(array|string $concrete)
 ...
 * @method static \GSManager\Foundation\Application getInstance()
 * @method static \GSManager\Contracts\Container\Container|\GSManager\Foundation\Application setInstance(\GSManager\Contracts\Container\Container|null $container = null)
 * @method static void macro(string $name, object|callable $macro)
 * @method static void mixin(object $mixin, bool $replace = true)
 * @method static bool hasMacro(string $name)
 * @method static void flushMacros()
 *
 * @see \GSManager\Foundation\Application
 */
