 ...
 * @method static \GSManager\Session\SessionManager extend(string $driver, \Closure $callback)
 * @method static array getDrivers()
 * @method static \GSManager\Contracts\Container\Container getContainer()
 * @method static \GSManager\Session\SessionManager setContainer(\GSManager\Contracts\Container\Container $container)
 * @method static \GSManager\Session\SessionManager forgetDrivers()
 ...
 * @method static \GSManager\Support\Uri previousUri()
 ...
 * @method static void setRequestOnHandler(\GSManager\Http\Request $request)
 * @method static void macro(string $name, object|callable $macro)
 * @method static void mixin(object $mixin, bool $replace = true)
 * @method static bool hasMacro(string $name)
 * @method static void flushMacros()
 *
 * @see \GSManager\Session\SessionManager
 */
