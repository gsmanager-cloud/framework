...
use GSManager\Database\Console\Migrations\FreshCommand;
use GSManager\Database\Console\Migrations\RefreshCommand;
use GSManager\Database\Console\Migrations\ResetCommand;
use GSManager\Database\Console\Migrations\RollbackCommand;
use GSManager\Database\Console\WipeCommand;

/**
 * @method static \GSManager\Database\Connection connection(string|null $name = null)
 * @method static \GSManager\Database\ConnectionInterface build(array $config)
 * @method static string calculateDynamicConnectionName(array $config)
 * @method static \GSManager\Database\ConnectionInterface connectUsing(string $name, array $config, bool $force = false)
 * @method static void purge(string|null $name = null)
 * @method static void disconnect(string|null $name = null)
 * @method static \GSManager\Database\Connection reconnect(string|null $name = null)
 ...
 * @method static \GSManager\Database\DatabaseManager setApplication(\GSManager\Contracts\Foundation\Application $app)
 ...
 * @method static \GSManager\Database\Schema\Builder getSchemaBuilder()
 * @method static \GSManager\Database\Query\Builder table(\Closure|\GSManager\Database\Query\Builder|\GSManager\Contracts\Database\Query\Expression|string $table, string|null $as = null)
 * @method static \GSManager\Database\Query\Builder query()
 ...
 * @method static \GSManager\Database\Connection beforeStartingTransaction(\Closure $callback)
 * @method static \GSManager\Database\Connection beforeExecuting(\Closure $callback)
 * @method static void listen(\Closure $callback)
 * @method static \GSManager\Contracts\Database\Query\Expression raw(mixed $value)
 ...
 * @method static \GSManager\Database\Connection setRecordModificationState(bool $value)
 * @method static void forgetRecordModificationState()
 * @method static \GSManager\Database\Connection useWriteConnectionWhenReading(bool $value = true)
 * @method static \PDO getPdo()
 * @method static \PDO|\Closure|null getRawPdo()
 * @method static \PDO getReadPdo()
 * @method static \PDO|\Closure|null getRawReadPdo()
 * @method static \GSManager\Database\Connection setPdo(\PDO|\Closure|null $pdo)
 * @method static \GSManager\Database\Connection setReadPdo(\PDO|\Closure|null $pdo)
 ...
 * @method static \GSManager\Database\Query\Grammars\Grammar getQueryGrammar()
 * @method static \GSManager\Database\Connection setQueryGrammar(\GSManager\Database\Query\Grammars\Grammar $grammar)
 * @method static \GSManager\Database\Schema\Grammars\Grammar getSchemaGrammar()
 * @method static \GSManager\Database\Connection setSchemaGrammar(\GSManager\Database\Schema\Grammars\Grammar $grammar)
 * @method static \GSManager\Database\Query\Processors\Processor getPostProcessor()
 * @method static \GSManager\Database\Connection setPostProcessor(\GSManager\Database\Query\Processors\Processor $processor)
 * @method static \GSManager\Contracts\Events\Dispatcher getEventDispatcher()
 * @method static \GSManager\Database\Connection setEventDispatcher(\GSManager\Contracts\Events\Dispatcher $events)
 * @method static void unsetEventDispatcher()
 * @method static \GSManager\Database\Connection setTransactionManager(\GSManager\Database\DatabaseTransactionsManager $manager)
 ...
 * @method static \GSManager\Database\Connection setDatabaseName(string $database)
 * @method static \GSManager\Database\Connection setReadWriteType(string|null $readWriteType)
 * @method static string getTablePrefix()
 * @method static \GSManager\Database\Connection setTablePrefix(string $prefix)
 ...
 *
 * @see \GSManager\Database\DatabaseManager
 */
