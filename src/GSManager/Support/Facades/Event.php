...
use GSManager\Support\Testing\Fakes\EventFake;

/**
 * @method static void listen(\GSManager\Events\QueuedClosure|callable|array|string $events, \GSManager\Events\QueuedClosure|callable|array|string|null $listener = null)
 ...
 * @method static \GSManager\Events\Dispatcher setQueueResolver(callable $resolver)
 * @method static \GSManager\Events\Dispatcher setTransactionManagerResolver(callable $resolver)
 * @method static array getRawListeners()
 * @method static void macro(string $name, object|callable $macro)
 * @method static void mixin(object $mixin, bool $replace = true)
 * @method static bool hasMacro(string $name)
 * @method static void flushMacros()
 * @method static \GSManager\Support\Testing\Fakes\EventFake except(array|string $eventsToDispatch)
 ...
 * @method static \GSManager\Support\Collection dispatched(string $event, callable|null $callback = null)
 * @method static bool hasDispatched(string $event)
 * @method static array dispatchedEvents()
 *
 * @see \GSManager\Events\Dispatcher
 * @see \GSManager\Support\Testing\Fakes\EventFake
 */
class Event extends Facade
{
     ...
     * @return \GSManager\Support\Testing\Fakes\EventFake
     */
