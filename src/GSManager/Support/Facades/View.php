...
/**
 * @method static \GSManager\Contracts\View\View file(string $path, \GSManager\Contracts\Support\Arrayable|array $data = [], array $mergeData = [])
 * @method static \GSManager\Contracts\View\View make(string $view, \GSManager\Contracts\Support\Arrayable|array $data = [], array $mergeData = [])
 * @method static \GSManager\Contracts\View\View first(array $views, \GSManager\Contracts\Support\Arrayable|array $data = [], array $mergeData = [])
 * @method static string renderWhen(bool $condition, string $view, \GSManager\Contracts\Support\Arrayable|array $data = [], array $mergeData = [])
 * @method static string renderUnless(bool $condition, string $view, \GSManager\Contracts\Support\Arrayable|array $data = [], array $mergeData = [])
 * @method static string renderEach(string $view, array $data, string $iterator, string $empty = 'raw|')
 * @method static bool exists(string $view)
 * @method static \GSManager\Contracts\View\Engine getEngineFromPath(string $path)
 ...
 * @method static \GSManager\View\Factory addNamespace(string $namespace, string|array $hints)
 * @method static \GSManager\View\Factory prependNamespace(string $namespace, string|array $hints)
 * @method static \GSManager\View\Factory replaceNamespace(string $namespace, string|array $hints)
 ...
 * @method static \GSManager\View\Engines\EngineResolver getEngineResolver()
 * @method static \GSManager\View\ViewFinderInterface getFinder()
 * @method static void setFinder(\GSManager\View\ViewFinderInterface $finder)
 ...
 * @method static void setContainer(\GSManager\Contracts\Container\Container $container)
 ...
 * @method static void startComponent(\GSManager\Contracts\View\View|\GSManager\Contracts\Support\Htmlable|\Closure|string $view, array $data = [])
 ...
 * @method static void callComposer(\GSManager\Contracts\View\View $view)
 * @method static void callCreator(\GSManager\Contracts\View\View $view)
