...
use GSManager\Contracts\Support\DeferringDisplayableValue;
...
use GSManager\Support\HigherOrderTapProxy;
use GSManager\Support\Once;
use GSManager\Support\Onceable;
use GSManager\Support\Optional;
...
if (! function_exists('e')) {
     ...
     *
     * @param  \GSManager\Contracts\Support\DeferringDisplayableValue|\GSManager\Contracts\Support\Htmlable|\BackedEnum|string|int|float|null  $value
...
if (! function_exists('fluent')) {
     ...
     * @return \GSManager\Support\Fluent
     */
...
if (! function_exists('gsmanager_cloud')) {
    /**
     * Determine if the application is running on GSManager Cloud.
     *
     * @return bool
     */
    function gsmanager_cloud()
    {
        return ($_ENV['GSMANAGER_CLOUD'] ?? false) === '1' ||
               ($_SERVER['GSMANAGER_CLOUD'] ?? false) === '1';
    }
}
...
if (! function_exists('optional')) {
     ...
     * @return ($callback is null ? \GSManager\Support\Optional : ($value is null ? null : TReturn))
     */
...
if (! function_exists('str')) {
     ...
     * @return ($string is null ? object : \GSManager\Support\Stringable)
     */
...
if (! function_exists('tap')) {
     ...
     * @return ($callback is null ? \GSManager\Support\HigherOrderTapProxy : TValue)
     */
