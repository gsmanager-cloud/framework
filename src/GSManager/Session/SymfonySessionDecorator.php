...
{
    /**
     * The underlying GSManager session store.
     *
     ...
     *
     * @param  \GSManager\Contracts\Session\Session  $store
     */
    ...
    {
        throw new BadMethodCallException('Method not implemented by GSManager.');
    }
