...
use GSManager\Testing\Assert as PHPUnit;
...
class AssertableJsonString implements ArrayAccess, Countable
{
     ...
     *
     * @var \GSManager\Contracts\Support\Jsonable|\JsonSerializable|array|string
     */
    public $json;
     ...
     *
     * @param  \GSManager\Contracts\Support\Jsonable|\JsonSerializable|array|string  $jsonable
     */
