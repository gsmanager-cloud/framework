...
class ParallelTesting
{
     ...
     *
     * @param  \GSManager\Foundation\Testing\TestCase  $testCase
     * @return void
     */
    ...
    public function option($option)
    {
        $optionsResolver = $this->optionsResolver ?: function ($option) {
            $option = 'GSMANAGER_PARALLEL_TESTING_'.Str::upper($option);
    ...
    {
        return ! empty($_SERVER['GSMANAGER_PARALLEL_TESTING']) && $this->token();
    }
}
