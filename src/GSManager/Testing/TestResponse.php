...
use ArrayAccess;
use Closure;
use GSManager\Contracts\Support\MessageBag;
use GSManager\Contracts\View\View;
use GSManager\Cookie\CookieValuePrefix;
...
use GSManager\Testing\TestResponseAssert as PHPUnit;
use LogicException;
...
class TestResponse implements ArrayAccess
{
     ...
     *
     * @var \GSManager\Http\Request|null
     */
    public $baseRequest;
     ...
     *
     * @return \GSManager\Testing\AssertableJsonString
     *
     * @throws \Throwable
     */
     ...
     *
     * @return \GSManager\Session\Store
     */
     ...
     *
     * @param  \GSManager\Support\Collection  $exceptions
     * @return $this
     */
