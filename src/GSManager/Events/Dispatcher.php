...
use GSManager\Contracts\Container\Container as ContainerContract;
use GSManager\Contracts\Events\Dispatcher as DispatcherContract;
use GSManager\Contracts\Events\ShouldDispatchAfterCommit;
use GSManager\Contracts\Events\ShouldHandleEventsAfterCommit;
...
class Dispatcher implements DispatcherContract
{
     ...
     *
     * @param  \GSManager\Events\QueuedClosure|callable|array|class-string|string  $events
     * @param  \GSManager\Events\QueuedClosure|callable|array|class-string|null  $listener
     * @return void
     */
     ...
     *
     * @param  \GSManager\Contracts\Broadcasting\ShouldBroadcast  $event
     * @return void
     */
     ...
     *
     * @param  mixed  $listener
     * @param  \GSManager\Events\CallQueuedListener  $job
     * @return mixed
     */
     ...
     *
     * @return \GSManager\Database\DatabaseTransactionsManager|null
     */
