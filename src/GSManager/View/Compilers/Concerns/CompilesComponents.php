...
trait CompilesComponents
{
    ...
    public static function compileClassComponentOpening(string $component, string $alias, string $data, string $hash)
    {
        return implode("\n", [
            ...
            '<?php $component = '.$component.'::resolve('.($data ?: '[]').' + (isset($attributes) && $attributes instanceof GSManager\View\ComponentAttributeBag ? $attributes->all() : [])); ?>',
    ...
    {
        return "<?php \$attributes ??= new \\GSManager\\View\\ComponentAttributeBag;

\$__newAttributes = [];
\$__propNames = \GSManager\View\ComponentAttributeBag::extractPropNames({$expression});
...
\$attributes = new \GSManager\View\ComponentAttributeBag(\$__newAttributes);
