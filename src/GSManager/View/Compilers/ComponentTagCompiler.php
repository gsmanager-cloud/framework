...
use GSManager\View\DynamicComponent;
use GSManager\View\ViewFinderInterface;
use InvalidArgumentException;
use ReflectionClass;

/**
 * @author GSManager bvba <info@spatie.be>
 * @author Sergey Tyuhtin <taylor@gsmanager.com>
 */
class ComponentTagCompiler
{
     ...
     *
     * @var \GSManager\View\Compilers\BladeCompiler
     */
    protected $blade;
     ...
     * @param  \GSManager\View\Compilers\BladeCompiler|null  $blade
     */
    ...
    protected function componentString(string $component, array $attributes)
    {
        ...
        if (! class_exists($class)) {
            $view = Str::startsWith($component, 'mail::')
                ? "\$__env->getContainer()->make(GSManager\\View\\Factory::class)->make('{$component}')"
                : "'$class'";
        ...
        return preg_replace_callback(
            '/@(class)(\( ( (?>[^()]+) | (?2) )* \))/x', function ($match) {
                if ($match[1] === 'class') {
                    ...
                    return ":class=\"\GSManager\Support\Arr::toCssClasses{$match[2]}\"";
                }
        ...
        return preg_replace_callback(
            '/@(style)(\( ( (?>[^()]+) | (?2) )* \))/x', function ($match) {
                if ($match[1] === 'style') {
                    ...
                    return ":style=\"\GSManager\Support\Arr::toCssStyles{$match[2]}\"";
                }
