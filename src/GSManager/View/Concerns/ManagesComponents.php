...
trait ManagesComponents
{
     ...
     *
     * @param  \GSManager\Contracts\View\View|\GSManager\Contracts\Support\Htmlable|\Closure|string  $view
     * @param  array  $data
     * @return void
     */
