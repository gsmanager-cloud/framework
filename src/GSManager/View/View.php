...
namespace GSManager\View;

use ArrayAccess;
use BadMethodCallException;
use GSManager\Contracts\Support\Arrayable;
use GSManager\Contracts\Support\Htmlable;
use GSManager\Contracts\Support\MessageProvider;
use GSManager\Contracts\Support\Renderable;
use GSManager\Contracts\View\Engine;
use GSManager\Contracts\View\View as ViewContract;
...
class View implements ArrayAccess, Htmlable, Stringable, ViewContract
{
     ...
     *
     * @var \GSManager\Contracts\View\Engine
     */
    protected $engine;
     ...
     *
     * @param  \GSManager\View\Factory  $factory
     * @param  \GSManager\Contracts\View\Engine  $engine
     * @param  string  $view
     * @param  string  $path
     * @param  mixed  $data
     */
     ...
     *
     * @param  \GSManager\Contracts\Support\MessageProvider|array|string  $provider
     * @param  string  $bag
     * @return $this
     */
     ...
     *
     * @return \GSManager\Contracts\View\Engine
     */
