...
use Closure;
use GSManager\Contracts\Auth\Factory as FactoryContract;
use InvalidArgumentException;

/**
 * @mixin \GSManager\Contracts\Auth\Guard
 * @mixin \GSManager\Contracts\Auth\StatefulGuard
 */
class AuthManager implements FactoryContract
{
     ...
     * @param  string  $name
     * @param  array  $config
     * @return \GSManager\Auth\SessionGuard
     */
     ...
     * @param  string  $name
     * @param  array  $config
     * @return \GSManager\Auth\TokenGuard
     */
