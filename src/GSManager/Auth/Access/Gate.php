...
namespace GSManager\Auth\Access;

use Closure;
use Exception;
use GSManager\Auth\Access\Events\GateEvaluated;
...
use GSManager\Database\Eloquent\Attributes\UsePolicy;
...
class Gate implements GateContract
{
     ...
     *
     * @var \GSManager\Auth\Access\Response|null
     */
     ...
     *
     * @param  \GSManager\Auth\Access\Response|\Closure|bool  $condition
     * @param  string|null  $message
     * @param  string|null  $code
     * @return \GSManager\Auth\Access\Response
     *
     ...
     *
     * @param  \GSManager\Contracts\Auth\Authenticatable|mixed  $user
     * @return static
     */
     ...
     *
     * @param  \GSManager\Auth\Access\Response  $response
     * @return $this
     */
