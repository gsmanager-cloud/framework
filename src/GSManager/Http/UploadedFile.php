...
use GSManager\Contracts\Filesystem\FileNotFoundException;
use GSManager\Http\Testing\FileFactory;
...
class UploadedFile extends SymfonyUploadedFile
{
     ...
     *
     * @return \GSManager\Http\Testing\FileFactory
     */
     ...
     * @return false|string
     *
     * @throws \GSManager\Contracts\Filesystem\FileNotFoundException
     */
    public function get()
    {
        if (! $this->isValid()) {
