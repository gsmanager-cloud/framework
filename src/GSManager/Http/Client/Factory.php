...
/**
 * @mixin \GSManager\Http\Client\PendingRequest
 */
class Factory
{
    use Macroable {
     ...
     *
     * @var list<array{0: \GSManager\Http\Client\Request, 1: \GSManager\Http\Client\Response|null}>
     */
    protected $recorded = [];
     ...
     *
     * @var list<\GSManager\Http\Client\ResponseSequence>
     */
     ...
     *
     * @param  \GSManager\Contracts\Events\Dispatcher|null  $dispatcher
     */
     ...
     * @param  int  $status
     * @param  array<string, mixed>  $headers
     * @return \GSManager\Http\Client\RequestException
     */
     ...
     * @return \Closure(\GSManager\Http\Client\Request): \GuzzleHttp\Promise\PromiseInterface
     */
     ...
     *
     * @param  string  $url
     * @param  \GSManager\Http\Client\Response|\GuzzleHttp\Promise\PromiseInterface|callable|int|string|array|\GSManager\Http\Client\ResponseSequence  $callback
     * @return $this
     */
     ...
     * @param  \GSManager\Http\Client\Response|null  $response
     * @return void
     */
     ...
     *
     * @param  callable|(\Closure(\GSManager\Http\Client\Request, \GSManager\Http\Client\Response|null): bool)  $callback
     * @return void
     */
     ...
     *
     * @param  list<string|(\Closure(\GSManager\Http\Client\Request, \GSManager\Http\Client\Response|null): bool)|callable>  $callbacks
     * @return void
     */
     ...
     *
     * @param  (\Closure(\GSManager\Http\Client\Request, \GSManager\Http\Client\Response|null): bool)|callable  $callback
     * @return \GSManager\Support\Collection<int, array{0: \GSManager\Http\Client\Request, 1: \GSManager\Http\Client\Response|null}>
     */
     ...
     *
     * @return \GSManager\Contracts\Events\Dispatcher|null
     */
