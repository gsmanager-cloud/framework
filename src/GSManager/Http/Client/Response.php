...
class Response implements ArrayAccess, Stringable
{
     ...
     *
     * @param  callable|(\Closure(\GSManager\Http\Client\Response): mixed)  $callback
     * @return $this
     */
     ...
     *
     * @return \GSManager\Http\Client\RequestException|null
     */
     ...
     * @return $this
     *
     * @throws \GSManager\Http\Client\RequestException
     */
     ...
     *
     * @param  int|(\Closure(int, \GSManager\Http\Client\Response): bool)|callable  $statusCode
     * @return $this
     *
     * @throws \GSManager\Http\Client\RequestException
     */
