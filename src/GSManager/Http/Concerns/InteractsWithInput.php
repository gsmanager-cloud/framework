...
namespace GSManager\Http\Concerns;
...
use GSManager\Support\Traits\InteractsWithData;
use SplFileInfo;
...
trait InteractsWithInput
{
     ...
     *
     * @return array<string, \GSManager\Http\UploadedFile|\GSManager\Http\UploadedFile[]>
     */
    ...
    /**
     * Convert the given array of Symfony UploadedFiles to custom GSManager UploadedFiles.
     *
     ...
     * @param  string|null  $key
     * @param  mixed  $default
     * @return ($key is null ? array<string, \GSManager\Http\UploadedFile|\GSManager\Http\UploadedFile[]> : \GSManager\Http\UploadedFile|\GSManager\Http\UploadedFile[]|null)
     */
