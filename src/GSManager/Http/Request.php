...
use GSManager\Session\SymfonySessionDecorator;
...
class Request extends SymfonyRequest implements Arrayable, ArrayAccess
{
     ...
     *
     * @var array<int, \GSManager\Http\UploadedFile|\GSManager\Http\UploadedFile[]>
     */
    ...
    /**
     * Create a new GSManager HTTP request from server variables.
     *
     * @return static
     */
    ...
    /**
     * This method belongs to Symfony HttpFoundation and is not usually needed when using GSManager.
     *
    ...
    /**
     * Create a new request instance from the given GSManager request.
     *
     * @param  \GSManager\Http\Request  $from
     * @param  \GSManager\Http\Request|null  $to
     * @return static
     */
    public static function createFrom(self $from, $to = null)
    {
        ...
        if ($from->hasSession() && $session = $from->session()) {
            $request->setGSManagerSession($session);
        }
    ...
    /**
     * Create an GSManager request from a Symfony instance.
     *
     ...
     * @return void
     */
    public function setGSManagerSession($session)
    {
     ...
     * @param  mixed  $default
     * @return ($param is null ? \GSManager\Routing\Route : object|string|null)
     */
