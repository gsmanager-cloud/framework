...
namespace GSManager\Filesystem;

use Closure;
use GSManager\Container\Container;
use GSManager\Contracts\Debug\ExceptionHandler;
use GSManager\Contracts\Filesystem\Cloud as CloudFilesystemContract;
use GSManager\Contracts\Filesystem\Filesystem as FilesystemContract;
use GSManager\Http\File;
...
class FilesystemAdapter implements CloudFilesystemContract
{
     ...
     *
     * @param  string  $path
     * @param  \Psr\Http\Message\StreamInterface|\GSManager\Http\File|\GSManager\Http\UploadedFile|string|resource  $contents
     * @param  mixed  $options
     * @return string|bool
     */
     ...
     *
     * @param  \GSManager\Http\File|\GSManager\Http\UploadedFile|string  $path
     * @param  \GSManager\Http\File|\GSManager\Http\UploadedFile|string|array|null  $file
     * @param  mixed  $options
     * @return string|false
     */
