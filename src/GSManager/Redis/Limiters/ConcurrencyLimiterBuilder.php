...
namespace GSManager\Redis\Limiters;

use GSManager\Contracts\Redis\LimiterTimeoutException;
...
class ConcurrencyLimiterBuilder
{
     ...
     *
     * @var \GSManager\Redis\Connections\Connection
     */
    public $connection;
     ...
     * @return mixed
     *
     * @throws \GSManager\Contracts\Redis\LimiterTimeoutException
     */
