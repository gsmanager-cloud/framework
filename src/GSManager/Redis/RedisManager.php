...
use Closure;
use GSManager\Contracts\Redis\Factory;
use GSManager\Redis\Connections\Connection;
use GSManager\Redis\Connectors\PhpRedisConnector;
use GSManager\Redis\Connectors\PredisConnector;
use GSManager\Support\Arr;
use GSManager\Support\ConfigurationUrlParser;
use InvalidArgumentException;

/**
 * @mixin \GSManager\Redis\Connections\Connection
 */
class RedisManager implements Factory
{
     ...
     *
     * @return \GSManager\Contracts\Redis\Connector|null
     */
