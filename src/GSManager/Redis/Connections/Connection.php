...
namespace GSManager\Redis\Connections;

use Closure;
use GSManager\Contracts\Events\Dispatcher;
use GSManager\Redis\Events\CommandExecuted;
use GSManager\Redis\Limiters\ConcurrencyLimiterBuilder;
use GSManager\Redis\Limiters\DurationLimiterBuilder;
...
abstract class Connection
{
     ...
     *
     * @param  string  $name
     * @return \GSManager\Redis\Limiters\ConcurrencyLimiterBuilder
     */
     ...
     *
     * @param  string  $name
     * @return \GSManager\Redis\Limiters\DurationLimiterBuilder
     */
     ...
     * @return void
     *
     * @deprecated since GSManager 11.x
     */
