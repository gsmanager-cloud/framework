...
use GSManager\Support\Facades\Redis as RedisFacade;
...
class PhpRedisConnector implements Connector
{
     ...
     * @param  array  $config
     * @param  array  $options
     * @return \GSManager\Redis\Connections\PhpRedisConnection
     */
     ...
     * @param  array  $options
     * @return \GSManager\Redis\Connections\PhpRedisClusterConnection
     */
