...
namespace GSManager\Cache\Console;

use GSManager\Cache\CacheManager;
...
class ClearCommand extends Command
{
     ...
     *
     * @var \GSManager\Cache\CacheManager
     */
    protected $cache;
     ...
     *
     * @param  \GSManager\Cache\CacheManager  $cache
    ...
    {
        $this->gsmanager['events']->dispatch(
