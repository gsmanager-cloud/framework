...
use GSManager\Contracts\Cache\LockProvider;
use GSManager\Contracts\Redis\Factory as Redis;
use GSManager\Redis\Connections\PhpRedisClusterConnection;
use GSManager\Redis\Connections\PhpRedisConnection;
...
class RedisStore extends TaggableStore implements LockProvider
{
     ...
     * @return \GSManager\Contracts\Cache\Lock
     */
     ...
     * @return \GSManager\Cache\RedisTaggedCache
     */
     ...
     *
     * @return \GSManager\Contracts\Redis\Factory
     */
     ...
     *
     * @param  mixed  $value
     * @param  \GSManager\Redis\Connections\Connection  $connection
     * @return mixed
     */
