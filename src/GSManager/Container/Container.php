...
namespace GSManager\Container;

use ArrayAccess;
use Closure;
use Exception;
use GSManager\Contracts\Container\BindingResolutionException;
use GSManager\Contracts\Container\CircularDependencyException;
...
class Container implements ArrayAccess, ContainerContract
{
     ...
     * @return \GSManager\Contracts\Container\ContextualBindingBuilder
     */
     ...
     * @return \GSManager\Contracts\Container\Container|static
     */
