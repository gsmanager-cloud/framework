...
use GSManager\Contracts\Process\ProcessResult as ProcessResultContract;
...
class FakeProcessSequence
{
     ...
     *
     * @var \GSManager\Contracts\Process\ProcessResult|\GSManager\Process\FakeProcessDescription
     */
     ...
     *
     * @param  \GSManager\Contracts\Process\ProcessResult|\GSManager\Process\FakeProcessDescription|array|string  $process
     * @return $this
     */
     ...
     *
     * @param  \GSManager\Contracts\Process\ProcessResult|\GSManager\Process\FakeProcessDescription|array|string  $process
     * @return \GSManager\Contracts\Process\ProcessResult|\GSManager\Process\FakeProcessDescription
     */
