...
abstract class GeneratorCommand extends Command implements PromptsForMissingInput
{
    ...
    protected function getPath($name)
    {
        ...
        return $this->gsmanager['path'].'/'.str_replace('\\', '/', $name).'.php';
    }
    ...
    {
        return $this->gsmanager->getNamespace();
    }
    ...
    {
        $views = $this->gsmanager['config']['view.paths'][0] ?? resource_path('views');
