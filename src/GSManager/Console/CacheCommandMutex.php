...
use GSManager\Cache\DynamoDbStore;
use GSManager\Contracts\Cache\Factory as Cache;
...
class CacheCommandMutex implements CommandMutex
{
     ...
     *
     * @var \GSManager\Contracts\Cache\Factory
     */
    public $cache;
     ...
     *
     * @param  \GSManager\Contracts\Cache\Factory  $cache
     */
     ...
     *
     * @param  \GSManager\Console\Command  $command
     * @return bool
     */
