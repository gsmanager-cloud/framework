...
use GSManager\Support\ProcessUtils;
use GSManager\Support\Traits\Macroable;
use RuntimeException;

/**
 * @mixin \GSManager\Console\Scheduling\PendingEventAttributes
 */
class Schedule
{
    use Macroable {
     ...
     *
     * @var \GSManager\Console\Scheduling\Event[]
     */
    protected $events = [];
     ...
     *
     * @var \GSManager\Console\Scheduling\EventMutex
     */
     ...
     *
     * @var \GSManager\Console\Scheduling\SchedulingMutex
     */
     ...
     *
     * @var \GSManager\Console\Scheduling\PendingEventAttributes|null
     */
    ...
    public function __construct($timezone = null)
    {
        ...
        if (! class_exists(Container::class)) {
            throw new RuntimeException(
                'A container implementation is required to use the scheduler. Please install the gsmanager/container package.'
            );
        }
     ...
     * @return \GSManager\Console\Scheduling\CallbackEvent
     */
    ...
    protected function dispatchToQueue($job, $queue, $connection)
    {
        if ($job instanceof Closure) {
            if (! class_exists(CallQueuedClosure::class)) {
                throw new RuntimeException(
                    'To enable support for closure jobs, please install the gsmanager/queue package.'
                );
            }
     ...
     *
     * @return \GSManager\Contracts\Bus\Dispatcher
     *
     * @throws \RuntimeException
     */
    protected function getDispatcher()
    {
        if ($this->dispatcher === null) {
            try {
                ...
                throw new RuntimeException(
                    'Unable to resolve the dispatcher from the service container. Please bind it or install the gsmanager/bus package.',
