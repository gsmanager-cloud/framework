...
use GSManager\Contracts\Routing\BindingRegistrar;
use GSManager\Contracts\Routing\Registrar as RegistrarContract;
...
use GSManager\Routing\Events\PreparingResponse;
use GSManager\Routing\Events\ResponsePrepared;
use GSManager\Routing\Events\RouteMatched;
use GSManager\Routing\Events\Routing;
...
use GSManager\Support\Traits\Tappable;
...
/**
 * @mixin \GSManager\Routing\RouteRegistrar
 */
class Router implements BindingRegistrar, RegistrarContract
{
     ...
     *
     * @var \GSManager\Routing\RouteCollectionInterface
     */
    protected $routes;
     ...
     *
     * @var \GSManager\Routing\Route|null
     */
    protected $current;
     ...
     * @param  \GSManager\Container\Container|null  $container
     */
    ...
    {
        return $this->any($uri, '\GSManager\Routing\RedirectController')
    ...
    {
        return $this->match(['GET', 'HEAD'], $uri, '\GSManager\Routing\ViewController')
            ->setDefaults([
                'view' => $view,
                'data' => $data,
     ...
     *
     * @param  \GSManager\Support\Collection  $middlewares
     * @return array
     */
     ...
     *
     * @return \GSManager\Routing\RouteCollectionInterface
     */
