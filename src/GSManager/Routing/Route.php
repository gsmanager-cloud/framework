...
use GSManager\Routing\Contracts\CallableDispatcher;
...
use GSManager\Routing\Matching\HostValidator;
use GSManager\Routing\Matching\MethodValidator;
use GSManager\Routing\Matching\SchemeValidator;
use GSManager\Routing\Matching\UriValidator;
...
class Route
{
    ...
    public function getMissing()
    {
        ...
        return is_string($missing) &&
            Str::startsWith($missing, [
                'O:47:"GSManager\\SerializableClosure\\SerializableClosure',
                'O:55:"GSManager\\SerializableClosure\\UnsignedSerializableClosure',
     ...
     *
     * @return \GSManager\Routing\Contracts\ControllerDispatcher
     *
     * @throws \GSManager\Contracts\Container\BindingResolutionException
     */
