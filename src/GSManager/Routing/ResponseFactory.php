...
use Closure;
use GSManager\Contracts\Routing\ResponseFactory as FactoryContract;
use GSManager\Contracts\View\Factory as ViewFactory;
use GSManager\Http\JsonResponse;
use GSManager\Http\Response;
use GSManager\Http\StreamedEvent;
use GSManager\Routing\Exceptions\StreamedResponseException;
use GSManager\Support\Js;
...
class ResponseFactory implements FactoryContract
{
     ...
     * @param  array  $headers
     * @param  \GSManager\Http\StreamedEvent|string|null  $endStreamWith
     ...
     * @return \Symfony\Component\HttpFoundation\StreamedResponse
     *
     * @throws \GSManager\Routing\Exceptions\StreamedResponseException
     */
