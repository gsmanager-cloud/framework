...
use Closure;
use GSManager\Contracts\Queue\Factory as FactoryContract;
use GSManager\Contracts\Queue\Monitor as MonitorContract;
...
class QueueManager implements FactoryContract, MonitorContract
{
     ...
     *
     * @param  string  $driver
     * @return \GSManager\Queue\Connectors\ConnectorInterface
     *
     * @throws \InvalidArgumentException
     */
