...
namespace GSManager\Queue\Capsule;

use GSManager\Container\Container;
use GSManager\Queue\QueueManager;
use GSManager\Queue\QueueServiceProvider;
use GSManager\Support\Traits\CapsuleManagerTrait;

/**
 * @mixin \GSManager\Queue\QueueManager
 * @mixin \GSManager\Contracts\Queue\Queue
 */
class Manager
{
     ...
     *
     * @var \GSManager\Queue\QueueManager
     */
    protected $manager;
     ...
     *
     * @return \GSManager\Queue\QueueManager
     */
