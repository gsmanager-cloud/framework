...
namespace GSManager\Queue\Jobs;

use GSManager\Container\Container;
use GSManager\Contracts\Queue\Job as JobContract;
...
class DatabaseJob extends Job implements JobContract
{
     ...
     *
     * @var \GSManager\Queue\DatabaseQueue
     */
    protected $database;
     ...
     * @param  \GSManager\Queue\DatabaseQueue  $database
     * @param  \stdClass  $job
