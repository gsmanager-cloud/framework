...
use GSManager\Queue\Events\JobQueued;
use GSManager\Queue\Events\JobQueueing;
...
abstract class Queue
{
     ...
     * @return string
     *
     * @throws \GSManager\Queue\InvalidPayloadException
     */
    ...
    protected function createObjectPayload($job, $queue)
    {
        $payload = $this->withCreatePayloadHooks($queue, [
            ...
            'job' => 'GSManager\Queue\CallQueuedHandler@call',
     ...
     *
     * @return \GSManager\Container\Container
     */
