...
use GSManager\Contracts\Queue\ClearableQueue;
use GSManager\Contracts\Queue\Queue as QueueContract;
use GSManager\Database\Connection;
use GSManager\Queue\Jobs\DatabaseJob;
use GSManager\Queue\Jobs\DatabaseJobRecord;
...
class DatabaseQueue extends Queue implements QueueContract, ClearableQueue
{
     ...
     *
     * @param  \GSManager\Database\Connection  $database
     * @param  string  $table
     ...
     *
     * @param  string  $queue
     * @param  \GSManager\Queue\Jobs\DatabaseJobRecord  $job
     * @param  int  $delay
     * @return mixed
     */
     ...
     *
     * @param  string|null  $queue
     * @return \GSManager\Queue\Jobs\DatabaseJobRecord|null
     */
     ...
     * @param  string  $queue
     * @param  \GSManager\Queue\Jobs\DatabaseJobRecord  $job
     * @return \GSManager\Queue\Jobs\DatabaseJob
     */
     ...
     *
     * @param  \GSManager\Queue\Jobs\DatabaseJobRecord  $job
     * @return \GSManager\Queue\Jobs\DatabaseJobRecord
     */
     ...
     *
     * @param  string  $queue
     * @param  \GSManager\Queue\Jobs\DatabaseJob  $job
     * @param  int  $delay
     * @return void
     */
