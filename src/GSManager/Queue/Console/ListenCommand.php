...
use GSManager\Queue\Listener;
use GSManager\Queue\ListenerOptions;
...
class ListenCommand extends Command
{
     ...
     *
     * @param  \GSManager\Queue\Listener  $listener
     */
    ...
    {
        $connection = $connection ?: $this->gsmanager['config']['queue.default'];

        return $this->input->getOption('queue') ?: $this->gsmanager['config']->get(
     ...
     *
     * @return \GSManager\Queue\ListenerOptions
     */
