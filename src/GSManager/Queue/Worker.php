...
use GSManager\Contracts\Queue\Factory as QueueManager;
use GSManager\Database\DetectsLostConnections;
use GSManager\Queue\Events\JobAttempted;
use GSManager\Queue\Events\JobExceptionOccurred;
use GSManager\Queue\Events\JobPopped;
use GSManager\Queue\Events\JobPopping;
...
use GSManager\Queue\Events\JobTimedOut;
use GSManager\Queue\Events\Looping;
use GSManager\Queue\Events\WorkerStarting;
use GSManager\Queue\Events\WorkerStopping;
...
class Worker
{
     ...
     *
     * @param  \GSManager\Contracts\Queue\Factory  $manager
     * @param  \GSManager\Contracts\Events\Dispatcher  $events
     * @param  \GSManager\Contracts\Debug\ExceptionHandler  $exceptions
     ...
     *
     * @param  \GSManager\Contracts\Queue\Queue  $connection
     * @param  string  $queue
     * @return \GSManager\Contracts\Queue\Job|null
     */
    ...
    {
        if ($this->cache) {
            return $this->cache->get('gsmanager:queue:restart');
        }
    }
     ...
     *
     * @param  int  $status
     * @param  \GSManager\Queue\WorkerOptions|null  $options
     * @return never
     */
     ...
     *
     * @param  \GSManager\Contracts\Queue\Job  $job
     * @return \GSManager\Queue\MaxAttemptsExceededException
     */
     ...
     *
     * @param  \GSManager\Contracts\Queue\Job  $job
     * @return \GSManager\Queue\TimeoutExceededException
     */
     ...
     *
     * @return \GSManager\Contracts\Queue\Factory
     */
