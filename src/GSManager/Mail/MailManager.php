...
use Closure;
use GSManager\Contracts\Mail\Factory as FactoryContract;
use GSManager\Log\LogManager;
use GSManager\Mail\Transport\ArrayTransport;
use GSManager\Mail\Transport\LogTransport;
use GSManager\Mail\Transport\ResendTransport;
use GSManager\Mail\Transport\SesTransport;
use GSManager\Mail\Transport\SesV2Transport;
use GSManager\Support\Arr;
use GSManager\Support\ConfigurationUrlParser;
...
class MailManager implements FactoryContract
{
     ...
     *
     * @param  array  $config
     * @return \GSManager\Mail\Transport\SesTransport
     */
     ...
     *
     * @param  array  $config
     * @return \GSManager\Mail\Transport\SesV2Transport
     */
     ...
     *
     * @param  array  $config
     * @return \GSManager\Mail\Transport\ResendTransprot
     */
    ...
    protected function createRoundrobinTransportOfClass(array $config, string $class)
    {
        ...
        foreach ($config['mailers'] as $name) {
            ...
            // with any GSManager <= 6.x application style mail configuration files.
     ...
     *
     * @param  array  $config
     * @return \GSManager\Mail\Transport\LogTransport
     */
     ...
     *
     * @return \GSManager\Mail\Transport\ArrayTransport
     */
     ...
     *
     * @param  \GSManager\Mail\Mailer  $mailer
     * @param  array  $config
     * @param  string  $type
     * @return void
     */
    ...
    protected function getConfig(string $name)
    {
        ...
        // provide "BC" for any GSManager <= 6.x style mail configuration files.
    ...
    public function getDefaultDriver()
    {
        ...
        // of the GSManager mail configuration file for backwards compatibility.
