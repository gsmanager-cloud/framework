...
use GSManager\Contracts\Filesystem\Factory as FilesystemFactory;
use GSManager\Contracts\Mail\Attachable;
use GSManager\Contracts\Mail\Factory as MailFactory;
use GSManager\Contracts\Mail\Mailable as MailableContract;
use GSManager\Contracts\Queue\Factory as Queue;
...
use GSManager\Support\Traits\Localizable;
...
class Mailable implements MailableContract, Renderable
{
     ...
     *
     * @param  \GSManager\Contracts\Mail\Factory|\GSManager\Contracts\Mail\Mailer  $mailer
    ...
    {
        return [
            '__gsmanager_mailable' => get_class($this),
        ];
    }
     ...
     *
     * @param  \GSManager\Mail\Attachment  $attachment
     * @param  array  $options
     * @return bool
     */
