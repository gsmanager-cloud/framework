...
namespace GSManager\Mail\Mailables;
...
class Envelope
{
     ...
     *
     * @var \GSManager\Mail\Mailables\Address|string|null
     */
    public $from;
     ...
     *
     * @param  \GSManager\Mail\Mailables\Address|string|null  $from
     * @param  array<int, \GSManager\Mail\Mailables\Address|string>  $to
     * @param  array<int, \GSManager\Mail\Mailables\Address|string>  $cc
     * @param  array<int, \GSManager\Mail\Mailables\Address|string>  $bcc
     * @param  array<int, \GSManager\Mail\Mailables\Address|string>  $replyTo
     ...
     *
     * @param  array<int, \GSManager\Mail\Mailables\Address|string>  $addresses
     * @return array<int, \GSManager\Mail\Mailables\Address>
     */
     ...
     *
     * @param  \GSManager\Mail\Mailables\Address|string  $address
     ...
     *
     * @param  \GSManager\Mail\Mailables\Address|array<int, \GSManager\Mail\Mailables\Address|string>|string  $address
     * @param  string|null  $name
     * @return $this
     */
