...
use GSManager\Contracts\Mail\MailQueue as MailQueueContract;
use GSManager\Contracts\Queue\Factory as QueueContract;
use GSManager\Contracts\Queue\ShouldQueue;
use GSManager\Contracts\Support\Htmlable;
use GSManager\Contracts\View\Factory;
use GSManager\Mail\Events\MessageSending;
use GSManager\Mail\Events\MessageSent;
use GSManager\Mail\Mailables\Address;
...
class Mailer implements MailerContract, MailQueueContract
{
     ...
     *
     * @param  string  $name
     * @param  \GSManager\Contracts\View\Factory  $views
     * @param  \Symfony\Component\Mailer\Transport\TransportInterface  $transport
     * @param  \GSManager\Contracts\Events\Dispatcher|null  $events
     */
     ...
     *
     * @param  \BackedEnum|string|null  $queue
     * @param  \GSManager\Contracts\Mail\Mailable  $view
     * @return mixed
     */
     ...
     *
     * @param  \GSManager\Mail\SentMessage  $message
     * @param  array  $data
     * @return void
     */
     ...
     *
     * @return \GSManager\Contracts\View\Factory
     */
