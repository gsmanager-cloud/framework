...
use GSManager\Broadcasting\Broadcasters\AblyBroadcaster;
use GSManager\Broadcasting\Broadcasters\LogBroadcaster;
use GSManager\Broadcasting\Broadcasters\NullBroadcaster;
use GSManager\Broadcasting\Broadcasters\PusherBroadcaster;
use GSManager\Broadcasting\Broadcasters\RedisBroadcaster;
use GSManager\Bus\UniqueLock;
use GSManager\Contracts\Broadcasting\Factory as FactoryContract;
use GSManager\Contracts\Broadcasting\ShouldBeUnique;
use GSManager\Contracts\Broadcasting\ShouldBroadcastNow;
use GSManager\Contracts\Broadcasting\ShouldRescue;
...
/**
 * @mixin \GSManager\Contracts\Broadcasting\Broadcaster
 */
class BroadcastManager implements FactoryContract
{
     ...
     *
     * @param  \GSManager\Contracts\Container\Container  $app
     */
    ...
    public function routes(?array $attributes = null)
    {
        ...
        $this->app['router']->group($attributes, function ($router) {
            ...
            )->withoutMiddleware([\GSManager\Foundation\Http\Middleware\VerifyCsrfToken::class]);
        });
    }
