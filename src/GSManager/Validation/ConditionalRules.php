...
class ConditionalRules
{
     ...
     *
     * @var \GSManager\Contracts\Validation\ValidationRule|\GSManager\Contracts\Validation\InvokableRule|\GSManager\Contracts\Validation\Rule|\Closure|array|string
     */
    protected $rules;
