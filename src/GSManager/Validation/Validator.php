...
use GSManager\Contracts\Translation\Translator;
use GSManager\Contracts\Validation\DataAwareRule;
use GSManager\Contracts\Validation\ImplicitRule;
use GSManager\Contracts\Validation\Rule as RuleContract;
use GSManager\Contracts\Validation\Validator as ValidatorContract;
...
use GSManager\Support\ValidatedInput;
...
class Validator implements ValidatorContract
{
     ...
     *
     * @var \GSManager\Contracts\Translation\Translator
     */
     ...
     *
     * @var \GSManager\Validation\PresenceVerifierInterface
     */
     ...
     *
     * @var \GSManager\Support\MessageBag
     */
    protected $messages;
     ...
     *
     * @var class-string<\GSManager\Validation\ValidationException>
     */
     ...
     *
     * @param  \GSManager\Contracts\Translation\Translator  $translator
     * @param  array  $data
     * @param  array  $rules
     ...
     * @return \GSManager\Support\ValidatedInput|array
     */
     ...
     * @param  string  $attribute
     * @param  mixed  $value
     * @param  \GSManager\Contracts\Validation\Rule  $rule
     * @return void
     */
     ...
     *
     * @return \GSManager\Support\MessageBag
     */
     ...
     *
     * @param  string  $attribute
     * @return \GSManager\Support\Fluent|array|mixed
     */
     ...
     * @return \GSManager\Validation\PresenceVerifierInterface
     *
     ...
     *
     * @param  \GSManager\Validation\PresenceVerifierInterface  $presenceVerifier
     * @return void
     */
     ...
     *
     * @return class-string<\GSManager\Validation\ValidationException>
     */
     ...
     *
     * @param  class-string<\GSManager\Validation\ValidationException>  $exception
     * @return $this
     *
     ...
     *
     * @return \GSManager\Contracts\Translation\Translator
     */
