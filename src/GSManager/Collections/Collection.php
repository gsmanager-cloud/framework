...
use GSManager\Support\Traits\EnumeratesValues;
use GSManager\Support\Traits\Macroable;
use GSManager\Support\Traits\TransformsToResourceCollection;
 ...
 * @implements \GSManager\Support\Enumerable<TKey, TValue>
 */
class Collection implements ArrayAccess, CanBeEscapedWhenCastToString, Enumerable
{
    /**
     * @use \GSManager\Support\Traits\EnumeratesValues<TKey, TValue>
     */
     ...
     *
     * @param  \GSManager\Contracts\Support\Arrayable<TKey, TValue>|iterable<TKey, TValue>|null  $items
     */
     ...
     *
     * @return \GSManager\Support\LazyCollection<TKey, TValue>
     */
     ...
     *
     * @param  \GSManager\Contracts\Support\Arrayable<TCrossJoinKey, TCrossJoinValue>|iterable<TCrossJoinKey, TCrossJoinValue>  ...$lists
     ...
     *
     * @param  \GSManager\Contracts\Support\Arrayable<array-key, TValue>|iterable<array-key, TValue>  $items
     * @return static
     */
     ...
     *
     * @param  \GSManager\Contracts\Support\Arrayable<TKey, TValue>|iterable<TKey, TValue>  $items
     * @return static
     */
     ...
     *
     * @param  \GSManager\Contracts\Support\Arrayable<TKey, mixed>|iterable<TKey, mixed>  $items
     * @return static
     */
     ...
     *
     * @param  \GSManager\Support\Enumerable<array-key, TKey>|array<array-key, TKey>|string  $keys
     * @return static
     */
     ...
     *
     * \GSManager\Contracts\Support\Arrayable<array-key, TValue>|iterable<array-key, TKey>|TKey  $keys
     *
     * @return $this
     */
     ...
     *
     * @param  \GSManager\Contracts\Support\Arrayable<TKey, TMergeRecursiveValue>|iterable<TKey, TMergeRecursiveValue>  $items
     ...
     *
     * @param  \GSManager\Contracts\Support\Arrayable<array-key, TCombineValue>|iterable<array-key, TCombineValue>  $values
     ...
     *
     * @param  \GSManager\Support\Enumerable<array-key, TKey>|array<array-key, TKey>|string|null  $keys
     * @return static
     */
     ...
     * @return TValue
     *
     * @throws \GSManager\Support\ItemNotFoundException
     * @throws \GSManager\Support\MultipleItemsFoundException
     */
     ...
     * @template TZipValue
     *
     * @param  \GSManager\Contracts\Support\Arrayable<array-key, TZipValue>|iterable<array-key, TZipValue>  ...$items
     ...
     *
     * @return \GSManager\Support\Collection<TKey, TValue>
     */
