...
class ViewCacheCommand extends Command
{
     ...
     *
     * @param  \GSManager\Support\Collection  $views
     * @return void
     */
    protected function compileViews(Collection $views)
    {
        $compiler = $this->gsmanager['view']->getEngineResolver()->resolve('blade')->getCompiler();
    ...
    {
        $extensions = (new Collection($this->gsmanager['view']->getExtensions()))
    ...
    {
        $finder = $this->gsmanager['view']->getFinder();
