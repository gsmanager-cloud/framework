...
use GSManager\Foundation\Events\PublishingStubs;
...
class StubPublishCommand extends Command
{
    ...
    {
        if (! is_dir($stubsPath = $this->gsmanager->basePath('stubs'))) {
        ...
        $this->gsmanager['events']->dispatch($event = new PublishingStubs($stubs));
