...
class KeyGenerateCommand extends Command
{
    ...
    public function handle()
    {
        ...
        $this->gsmanager['config']['app.key'] = $key;
    ...
    protected function generateRandomKey()
    {
        return 'base64:'.base64_encode(
            Encrypter::generateKey($this->gsmanager['config']['app.cipher'])
        );
    }
    ...
    {
        $currentKey = $this->gsmanager['config']['app.key'];
    ...
    protected function writeNewEnvironmentFileWith($key)
    {
        $replaced = preg_replace(
            ...
            'APP_KEY='.$key,
            $input = file_get_contents($this->gsmanager->environmentFilePath())
        );
        ...
        file_put_contents($this->gsmanager->environmentFilePath(), $replaced);
    ...
    {
        $escaped = preg_quote('='.$this->gsmanager['config']['app.key'], '/');
