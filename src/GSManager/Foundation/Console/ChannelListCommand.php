...
use GSManager\Contracts\Broadcasting\Broadcaster;
...
class ChannelListCommand extends Command
{
     ...
     *
     * @param  \GSManager\Contracts\Broadcasting\Broadcaster  $broadcaster
     * @return void
     */
    public function handle(Broadcaster $broadcaster)
    {
        ...
        if (! $this->gsmanager->providerIsLoaded('App\Providers\BroadcastServiceProvider') &&
            file_exists($this->gsmanager->path('Providers/BroadcastServiceProvider.php'))) {
     ...
     *
     * @param  \GSManager\Support\Collection  $channels
     * @return array
     */
