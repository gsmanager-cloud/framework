...
use GSManager\Foundation\Events\VendorTagPublished;
...
use function GSManager\Prompts\search;
...
class VendorPublishCommand extends Command
{
    ...
    protected function publishTag($tag)
    {
        ...
        if ($publishing === false) {
            ...
            $this->gsmanager['events']->dispatch(new VendorTagPublished($tag, $pathsToPublish));
