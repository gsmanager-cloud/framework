...
use GSManager\Console\View\Components\BulletList;
use GSManager\Console\View\Components\Error;
use GSManager\Contracts\Container\Container;
use GSManager\Contracts\Debug\ExceptionHandler as ExceptionHandlerContract;
use GSManager\Contracts\Debug\ShouldntReport;
use GSManager\Contracts\Foundation\ExceptionRenderer;
use GSManager\Contracts\Support\Responsable;
use GSManager\Database\Eloquent\ModelNotFoundException;
use GSManager\Database\MultipleRecordsFoundException;
use GSManager\Database\RecordNotFoundException;
...
class Handler implements ExceptionHandlerContract
{
     ...
     *
     * @var \GSManager\Foundation\Exceptions\ReportableHandler[]
     */
     ...
     * @return \GSManager\Foundation\Exceptions\ReportableHandler
     */
    ...
    protected function shouldntReport(Throwable $e)
    {
        ...
        return rescue(fn () => with($this->throttle($e), function ($throttle) use ($e) {
            ...
            return ! $this->container->make(RateLimiter::class)->attempt(
                with($throttle->key ?: 'gsmanager:foundation:exceptions:'.$e::class, fn ($key) => $this->hashThrottleKeys ? hash('xxh128', $key) : $key),
     ...
     *
     * @param  \Throwable  $e
     * @return \GSManager\Support\Lottery|\GSManager\Cache\RateLimiting\Limit|null
     */
     ...
     * @param  \GSManager\Http\Request  $request
     * @param  \Throwable  $e
     * @return \GSManager\Http\Response|\GSManager\Http\JsonResponse|\GSManager\Http\RedirectResponse
     */
     ...
     *
     * @param  \GSManager\Http\Request  $request
     * @param  \GSManager\Auth\AuthenticationException  $exception
     * @return \GSManager\Http\Response|\GSManager\Http\JsonResponse|\GSManager\Http\RedirectResponse
     */
     ...
     *
     * @param  \GSManager\Validation\ValidationException  $e
     * @param  \GSManager\Http\Request  $request
     * @return \Symfony\Component\HttpFoundation\Response
     */
     ...
     *
     * @param  \GSManager\Http\Request  $request
     * @param  \GSManager\Validation\ValidationException  $exception
     * @return \GSManager\Http\Response|\GSManager\Http\JsonResponse|\GSManager\Http\RedirectResponse
     */
     ...
     *
     * @param  callable(\GSManager\Http\Request $request, \Throwable): bool  $callback
     * @return $this
     */
    ...
    protected function prepareResponse($request, Throwable $e)
    {
        if (! $this->isHttpException($e) && config('app.debug')) {
            return $this->toGSManagerResponse($this->convertExceptionToResponse($e), $e)->prepare($request);
        }
        ...
        return $this->toGSManagerResponse(
    ...
    /**
     * Map the given exception into an GSManager response.
     *
     * @param  \Symfony\Component\HttpFoundation\Response  $response
     * @param  \Throwable  $e
     * @return \GSManager\Http\Response|\GSManager\Http\RedirectResponse
     */
    protected function toGSManagerResponse($response, Throwable $e)
    {
