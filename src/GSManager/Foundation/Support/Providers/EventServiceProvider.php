...
namespace GSManager\Foundation\Support\Providers;

use GSManager\Auth\Events\Registered;
use GSManager\Auth\Listeners\SendEmailVerificationNotification;
use GSManager\Foundation\Events\DiscoverEvents;
