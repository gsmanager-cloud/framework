...
use GSManager\Support\Facades\DB;
use GSManager\Testing\Constraints\CountInDatabase;
use GSManager\Testing\Constraints\HasInDatabase;
use GSManager\Testing\Constraints\NotSoftDeletedInDatabase;
use GSManager\Testing\Constraints\SoftDeletedInDatabase;
...
trait InteractsWithDatabase
{
     ...
     *
     * @param  \GSManager\Database\Eloquent\Model|class-string<\GSManager\Database\Eloquent\Model>|string  $table
     ...
     *
     * @param  \GSManager\Database\Eloquent\Model|class-string<\GSManager\Database\Eloquent\Model>|string  $model
     * @return $this
     */
     ...
     *
     * @param  list<string>|class-string<\GSManager\Database\Seeder>|string  $class
     * @return $this
     */
    public function seed($class = 'Database\\Seeders\\DatabaseSeeder')
    {
        foreach (Arr::wrap($class) as $class) {
            $this->gsm('db:seed', ['--class' => $class, '--no-interaction' => true]);
        }
