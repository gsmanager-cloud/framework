...
use GSManager\Broadcasting\FakePendingBroadcast;
...
use GSManager\Contracts\Broadcasting\Factory as BroadcastFactory;
use GSManager\Contracts\Bus\Dispatcher;
use GSManager\Contracts\Cookie\Factory as CookieFactory;
use GSManager\Contracts\Debug\ExceptionHandler;
use GSManager\Contracts\Routing\ResponseFactory;
use GSManager\Contracts\Routing\UrlGenerator;
use GSManager\Contracts\Support\Responsable;
use GSManager\Contracts\Validation\Factory as ValidationFactory;
use GSManager\Contracts\View\Factory as ViewFactory;
use GSManager\Foundation\Bus\PendingClosureDispatch;
use GSManager\Foundation\Bus\PendingDispatch;
...
use GSManager\Queue\CallQueuedClosure;
...
if (! function_exists('abort')) {
     ...
     *
     * @param  \Symfony\Component\HttpFoundation\Response|\GSManager\Contracts\Support\Responsable|int  $code
     * @param  string  $message
     * @return never
     *
     * @throws \Symfony\Component\HttpKernel\Exception\HttpException
     * @throws \Symfony\Component\HttpKernel\Exception\NotFoundHttpException
     * @throws \GSManager\Http\Exceptions\HttpResponseException
     */
...
if (! function_exists('app')) {
     ...
     * @return ($abstract is class-string<TClass> ? TClass : ($abstract is null ? \GSManager\Foundation\Application : mixed))
     */
...
if (! function_exists('auth')) {
     ...
     * @return ($guard is null ? \GSManager\Contracts\Auth\Factory : \GSManager\Contracts\Auth\StatefulGuard)
     */
...
if (! function_exists('broadcast')) {
     ...
     * @return \GSManager\Broadcasting\PendingBroadcast
     */
...
if (! function_exists('cache')) {
     ...
     * @return ($key is null ? \GSManager\Cache\CacheManager : ($key is string ? mixed : bool))
     *
...
if (! function_exists('config')) {
     ...
     * @param  mixed  $default
     * @return ($key is null ? \GSManager\Config\Repository : ($key is string ? mixed : null))
     */
...
if (! function_exists('context')) {
     ...
     * @param  mixed  $default
     * @return ($key is string ? mixed : \GSManager\Log\Context\Repository)
     */
...
if (! function_exists('cookie')) {
     ...
     * @return ($name is null ? \GSManager\Cookie\CookieJar : \Symfony\Component\HttpFoundation\Cookie)
     */
...
if (! function_exists('csrf_field')) {
     ...
     *
     * @return \GSManager\Support\HtmlString
     */
    function csrf_field()
    {
...
if (! function_exists('defer')) {
    ...
    {
        return \GSManager\Support\defer($callback, $name, $always);
    }
}
...
if (! function_exists('dispatch')) {
     ...
     *
     * @param  mixed  $job
     * @return ($job is \Closure ? \GSManager\Foundation\Bus\PendingClosureDispatch : \GSManager\Foundation\Bus\PendingDispatch)
     */
...
if (! function_exists('logs')) {
     ...
     * @return ($driver is null ? \GSManager\Log\LogManager : \Psr\Log\LoggerInterface)
     */
...
if (! function_exists('mix')) {
     ...
     * @return \GSManager\Support\HtmlString|string
     *
     * @throws \Exception
     */
...
if (! function_exists('now')) {
     ...
     * @return \GSManager\Support\Carbon
     */
...
if (! function_exists('old')) {
     ...
     * @param  \GSManager\Database\Eloquent\Model|string|array|null  $default
...
if (! function_exists('redirect')) {
     ...
     * @param  array  $headers
     * @param  bool|null  $secure
     * @return ($to is null ? \GSManager\Routing\Redirector : \GSManager\Http\RedirectResponse)
     */
...
if (! function_exists('request')) {
     ...
     * @param  mixed  $default
     * @return ($key is null ? \GSManager\Http\Request : ($key is string ? mixed : array<string, mixed>))
     */
...
if (! function_exists('response')) {
     ...
     *
     * @param  \GSManager\Contracts\View\View|string|array|null  $content
     * @param  int  $status
     * @return ($content is null ? \GSManager\Contracts\Routing\ResponseFactory : \GSManager\Http\Response)
     */
...
if (! function_exists('session')) {
     ...
     * @param  array<string, mixed>|string|null  $key
     * @param  mixed  $default
     * @return ($key is null ? \GSManager\Session\SessionManager : ($key is string ? mixed : null))
     */
...
if (! function_exists('trans')) {
     ...
     * @param  array  $replace
     * @param  string|null  $locale
     * @return ($key is null ? \GSManager\Contracts\Translation\Translator : array|string)
     */
...
if (! function_exists('url')) {
     ...
     * @param  mixed  $parameters
     * @param  bool|null  $secure
     * @return ($path is null ? \GSManager\Contracts\Routing\UrlGenerator : string)
     */
...
if (! function_exists('validator')) {
     ...
     *
     * @return ($data is null ? \GSManager\Contracts\Validation\Factory : \GSManager\Contracts\Validation\Validator)
     */
...
if (! function_exists('view')) {
     ...
     * @return ($view is null ? \GSManager\Contracts\View\Factory : \GSManager\Contracts\View\View)
     */
