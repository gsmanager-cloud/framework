...
use GSManager\Contracts\Http\Kernel as HttpKernel;
use GSManager\Foundation\Application;
use GSManager\Foundation\Bootstrap\RegisterProviders;
use GSManager\Foundation\Events\DiagnosingHealth;
use GSManager\Foundation\Http\Middleware\PreventRequestsDuringMaintenance;
use GSManager\Foundation\Support\Providers\EventServiceProvider as AppEventServiceProvider;
use GSManager\Foundation\Support\Providers\RouteServiceProvider as AppRouteServiceProvider;
use GSManager\Support\Collection;
use GSManager\Support\Facades\Broadcast;
use GSManager\Support\Facades\Event;
use GSManager\Support\Facades\Route;
use GSManager\Support\Facades\View;
use GSManager\Folio\Folio;
...
class ApplicationBuilder
{
    ...
    {
        $this->app->singleton(
            \GSManager\Contracts\Http\Kernel::class,
            \GSManager\Foundation\Http\Kernel::class,
        );

        $this->app->singleton(
            \GSManager\Contracts\Console\Kernel::class,
            \GSManager\Foundation\Console\Kernel::class,
        );
     ...
     *
     * @param  callable(\GSManager\Console\Scheduling\Schedule $schedule): void  $callback
     * @return $this
     */
    ...
    {
        $this->app->singleton(
            \GSManager\Contracts\Debug\ExceptionHandler::class,
            \GSManager\Foundation\Exceptions\Handler::class
        );
     ...
     *
     * @return \GSManager\Foundation\Application
     */
