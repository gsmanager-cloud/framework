...
class Kernel implements KernelContract
{
    ...
    protected $middlewarePriority = [
        \GSManager\Foundation\Http\Middleware\HandlePrecognitiveRequests::class,
        ...
        \GSManager\Contracts\Auth\Middleware\AuthenticatesRequests::class,
        \GSManager\Routing\Middleware\ThrottleRequests::class,
        \GSManager\Routing\Middleware\ThrottleRequestsWithRedis::class,
        \GSManager\Contracts\Session\Middleware\AuthenticatesSessions::class,
