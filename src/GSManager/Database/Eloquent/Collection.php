 ...
 *
 * @extends \GSManager\Support\Collection<TKey, TModel>
 */
class Collection extends BaseCollection implements QueueableCollection
{
     ...
     * @return ($key is (\GSManager\Contracts\Support\Arrayable<array-key, mixed>|array<mixed>) ? static : TModel|TFindDefault)
     */
     ...
     * @return TModel
     *
     * @throws \GSManager\Database\Eloquent\ModelNotFoundException
     */
     ...
     *
     * @param  array<array-key, array|(callable(\GSManager\Database\Eloquent\Relations\Relation<*, *, *>): mixed)|string>|string  $relations
     * @return $this
     */
     ...
     *
     * @param  \GSManager\Database\Eloquent\Collection<int, TModel>  $models
     * @param  array  $path
     * @return void
     */
     ...
     * @param  array<array-key, array|(callable(\GSManager\Database\Eloquent\Relations\Relation<*, *, *>): mixed)|string>  $relations
     * @return $this
     */
     ...
     * @return \GSManager\Support\Collection<TKey, TMapValue>|static<TKey, TMapValue>
     */
     ...
     * @return \GSManager\Support\Collection<TMapWithKeysKey, TMapWithKeysValue>|static<TMapWithKeysKey, TMapWithKeysValue>
     */
     ...
     * @return \GSManager\Support\Collection<array-key, int>
     */
     ...
     *
     * @return \GSManager\Support\Collection<int, mixed>
     */
     ...
     *
     * @return \GSManager\Support\Collection<TModel, TKey>
     */
     ...
     *
     * @return \GSManager\Support\Collection<int, TKey>
     */
     ...
     * @return \GSManager\Support\Collection<int, TModel|TPadValue>
     */
     ...
     * @return \GSManager\Support\Collection<int<0, 1>, static<TKey, TModel>>
     */
     ...
     * @return \GSManager\Support\Collection<int, \GSManager\Support\Collection<int, TModel|TZipValue>>
     */
