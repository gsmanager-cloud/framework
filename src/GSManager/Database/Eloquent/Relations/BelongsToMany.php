...
use GSManager\Database\Eloquent\Relations\Concerns\InteractsWithPivotTable;
use GSManager\Database\Query\Grammars\MySqlGrammar;
 ...
 * @template TPivotModel of \GSManager\Database\Eloquent\Relations\Pivot = \GSManager\Database\Eloquent\Relations\Pivot
 * @template TAccessor of string = 'pivot'
 *
 * @extends \GSManager\Database\Eloquent\Relations\Relation<TRelatedModel, TDeclaringModel, \GSManager\Database\Eloquent\Collection<int, TRelatedModel&object{pivot: TPivotModel}>>
 *
...
class BelongsToMany extends Relation
{
     ...
     *
     * @var array<string|\GSManager\Contracts\Database\Query\Expression>
     */
     ...
     *
     * @param  \GSManager\Database\Eloquent\Builder<TRelatedModel>|null  $query
     * @return $this
     */
     ...
     *
     * @param  \GSManager\Database\Eloquent\Collection<int, TRelatedModel>  $results
     ...
     *
     * @template TNewPivotModel of \GSManager\Database\Eloquent\Relations\Pivot
     *
     ...
     *
     * @param  string|\GSManager\Contracts\Database\Query\Expression|array<string, string>  $column
     * @param  mixed  $value
     * @return $this
     *
     ...
     *     ? \GSManager\Database\Eloquent\Collection<int, TRelatedModel&object{pivot: TPivotModel}>
     ...
     * @return TRelatedModel&object{pivot: TPivotModel}
     *
     * @throws \GSManager\Database\Eloquent\ModelNotFoundException<TRelatedModel>
     ...
     * @param  array  $columns
     * @return \GSManager\Database\Eloquent\Collection<int, TRelatedModel&object{pivot: TPivotModel}>
     */
     ...
     * @return (
     *     $id is (\GSManager\Contracts\Support\Arrayable<array-key, mixed>|array<mixed>)
     *     ? \GSManager\Database\Eloquent\Collection<int, TRelatedModel&object{pivot: TPivotModel}>|TValue
     ...
     * @param  int|null  $page
     * @return \GSManager\Pagination\LengthAwarePaginator<int, TRelatedModel&object{pivot: TPivotModel}>
     */
     ...
     * @param  string  $pageName
     * @param  int|null  $page
     * @return \GSManager\Contracts\Pagination\Paginator<int, TRelatedModel&object{pivot: TPivotModel}>
     */
     ...
     * @return \GSManager\Contracts\Pagination\CursorPaginator<int, TRelatedModel&object{pivot: TPivotModel}>
     */
     ...
     *
     * @param  int  $chunkSize
     * @return \GSManager\Support\LazyCollection<int, TRelatedModel&object{pivot: TPivotModel}>
     */
     ...
     *
     * @return \GSManager\Database\Eloquent\Builder<TRelatedModel>
     */
     ...
     *
     * @return \GSManager\Support\Collection<int, int|string>
     */
     ...
     *
     * @template TContainer of \GSManager\Support\Collection<array-key, TRelatedModel>|array<array-key, TRelatedModel>
     *
     ...
     *
     * @param  \GSManager\Database\Eloquent\Builder<TRelatedModel>  $query
     * @param  \GSManager\Database\Eloquent\Builder<TDeclaringModel>  $parentQuery
     ...
     *
     * @param  string|\GSManager\Contracts\Database\Query\Expression  $column
     * @return string|\GSManager\Contracts\Database\Query\Expression
     */
