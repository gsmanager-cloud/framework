...
namespace GSManager\Database\Eloquent\Relations\Concerns;
...
trait CanBeOneOfMany
{
     ...
     *
     * @var \GSManager\Database\Eloquent\Builder<*>|null
     */
     ...
     *
     * @param  \GSManager\Database\Eloquent\Builder<*>  $query
     ...
     *
     * @param  \GSManager\Database\Eloquent\Builder<*>  $parent
     * @param  \GSManager\Database\Eloquent\Builder<*>  $subQuery
     ...
     *
     * @return \GSManager\Database\Eloquent\Builder<*>|void
     */
