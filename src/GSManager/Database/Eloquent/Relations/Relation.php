 ...
 * @template TResult
 *
 * @mixin \GSManager\Database\Eloquent\Builder<TRelatedModel>
 */
abstract class Relation implements BuilderContract
{
     ...
     *
     * @var \GSManager\Database\Eloquent\Builder<TRelatedModel>
     */
    protected $query;
     ...
     *
     * @var array<string, class-string<\GSManager\Database\Eloquent\Model>>
     */
    ...
    {
        return 'gsmanager_reserved_'.($incrementJoinCount ? static::$selfJoinCount++ : static::$selfJoinCount);
    }
     ...
     *
     * @param  array<string, class-string<\GSManager\Database\Eloquent\Model>>  $map
     * @param  bool  $merge
     * @return array
     */
     ...
     *
     * @param  array<string, class-string<\GSManager\Database\Eloquent\Model>>|null  $map
     * @param  bool  $merge
     * @return array<string, class-string<\GSManager\Database\Eloquent\Model>>
     */
     ...
     *
     * @param  list<class-string<\GSManager\Database\Eloquent\Model>>|null  $models
     * @return array<string, class-string<\GSManager\Database\Eloquent\Model>>|null
     */
     ...
     *
     * @param  string  $alias
     * @return class-string<\GSManager\Database\Eloquent\Model>|null
     */
     ...
     *
     * @param  class-string<\GSManager\Database\Eloquent\Model>  $className
     * @return int|string
     */
