 ...
 * @template TResult
 *
 * @extends \GSManager\Database\Eloquent\Relations\Relation<TRelatedModel, TIntermediateModel, TResult>
 */
abstract class HasOneOrManyThrough extends Relation
{
    ...
    protected function buildDictionary(EloquentCollection $results)
    {
        ...
        foreach ($results as $result) {
            $dictionary[$result->gsmanager_through_key][] = $result;
        }
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return ($id is (\GSManager\Contracts\Support\Arrayable<array-key, mixed>|array<mixed>) ? \GSManager\Database\Eloquent\Collection<int, TRelatedModel> : TRelatedModel|null)
     */
     ...
     * @param  array  $columns
     * @return \GSManager\Database\Eloquent\Collection<int, TRelatedModel>
     */
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return ($id is (\GSManager\Contracts\Support\Arrayable<array-key, mixed>|array<mixed>) ? \GSManager\Database\Eloquent\Collection<int, TRelatedModel> : TRelatedModel)
     *
     * @throws \GSManager\Database\Eloquent\ModelNotFoundException<TRelatedModel>
     */
     ...
     *     ? \GSManager\Database\Eloquent\Collection<int, TRelatedModel>|TValue
    ...
    protected function shouldSelect(array $columns = ['*'])
    {
        ...
        return array_merge($columns, [$this->getQualifiedFirstKeyName().' as gsmanager_through_key']);
    }
     ...
     *
     * @return \GSManager\Support\LazyCollection<int, TRelatedModel>
     */
