...
use GSManager\Database\Eloquent\PendingHasThroughRelationship;
use GSManager\Database\Eloquent\Relations\BelongsTo;
use GSManager\Database\Eloquent\Relations\BelongsToMany;
use GSManager\Database\Eloquent\Relations\HasMany;
use GSManager\Database\Eloquent\Relations\HasManyThrough;
use GSManager\Database\Eloquent\Relations\HasOne;
use GSManager\Database\Eloquent\Relations\HasOneThrough;
use GSManager\Database\Eloquent\Relations\MorphMany;
use GSManager\Database\Eloquent\Relations\MorphOne;
use GSManager\Database\Eloquent\Relations\MorphTo;
use GSManager\Database\Eloquent\Relations\MorphToMany;
...
trait HasRelationships
{
     ...
     * @return \GSManager\Database\Eloquent\Relations\HasOne<TRelatedModel, $this>
     */
     ...
     * @return \GSManager\Database\Eloquent\Relations\HasOneThrough<TRelatedModel, TIntermediateModel, $this>
     */
     ...
     * @param  string|null  $localKey
     * @return \GSManager\Database\Eloquent\Relations\MorphOne<TRelatedModel, $this>
     */
     ...
     * @return \GSManager\Database\Eloquent\Relations\BelongsTo<TRelatedModel, $this>
     */
     ...
     * @return \GSManager\Database\Eloquent\Relations\BelongsTo<TRelatedModel, TDeclaringModel>
     */
     ...
     * @param  string  $type
     * @param  string  $relation
     * @return \GSManager\Database\Eloquent\Relations\MorphTo<TRelatedModel, TDeclaringModel>
     */
     ...
     * @template TIntermediateModel of \GSManager\Database\Eloquent\Model
     *
     * @param  string|\GSManager\Database\Eloquent\Relations\HasMany<TIntermediateModel, covariant $this>|\GSManager\Database\Eloquent\Relations\HasOne<TIntermediateModel, covariant $this>  $relationship
     * @return (
     *     $relationship is string
     *     ? \GSManager\Database\Eloquent\PendingHasThroughRelationship<\GSManager\Database\Eloquent\Model, $this>
     *     : (
     *          $relationship is \GSManager\Database\Eloquent\Relations\HasMany<TIntermediateModel, $this>
     *          ? \GSManager\Database\Eloquent\PendingHasThroughRelationship<TIntermediateModel, $this, \GSManager\Database\Eloquent\Relations\HasMany<TIntermediateModel, $this>>
     *          : \GSManager\Database\Eloquent\PendingHasThroughRelationship<TIntermediateModel, $this, \GSManager\Database\Eloquent\Relations\HasOne<TIntermediateModel, $this>>
     *     )
     * )
     */
     ...
     * @param  string|null  $foreignKey
     * @param  string|null  $localKey
     * @return \GSManager\Database\Eloquent\Relations\HasMany<TRelatedModel, $this>
     */
     ...
     * @param  string  $foreignKey
     * @param  string  $localKey
     * @return \GSManager\Database\Eloquent\Relations\HasMany<TRelatedModel, TDeclaringModel>
     */
     ...
     * @param  string|null  $localKey
     * @param  string|null  $secondLocalKey
     * @return \GSManager\Database\Eloquent\Relations\HasManyThrough<TRelatedModel, TIntermediateModel, $this>
     */
     ...
     * @param  string  $localKey
     * @param  string  $secondLocalKey
     * @return \GSManager\Database\Eloquent\Relations\HasManyThrough<TRelatedModel, TIntermediateModel, TDeclaringModel>
     */
     ...
     * @param  string|null  $id
     * @param  string|null  $localKey
     * @return \GSManager\Database\Eloquent\Relations\MorphMany<TRelatedModel, $this>
     */
     ...
     * @param  string  $id
     * @param  string  $localKey
     * @return \GSManager\Database\Eloquent\Relations\MorphMany<TRelatedModel, TDeclaringModel>
     */
     ...
     *
     * @param  class-string<TRelatedModel>  $related
     * @param  string|class-string<\GSManager\Database\Eloquent\Model>|null  $table
     * @param  string|null  $foreignPivotKey
     * @param  string|null  $relatedPivotKey
     * @param  string|null  $parentKey
     * @param  string|null  $relatedKey
     * @param  string|null  $relation
     * @return \GSManager\Database\Eloquent\Relations\BelongsToMany<TRelatedModel, $this, \GSManager\Database\Eloquent\Relations\Pivot>
     */
     ...
     * @param  \GSManager\Database\Eloquent\Builder<TRelatedModel>  $query
     * @param  TDeclaringModel  $parent
     * @param  string|class-string<\GSManager\Database\Eloquent\Model>  $table
     * @param  string  $foreignPivotKey
     * @param  string  $relatedPivotKey
     * @param  string  $parentKey
     * @param  string  $relatedKey
     * @param  string|null  $relationName
     * @return \GSManager\Database\Eloquent\Relations\BelongsToMany<TRelatedModel, TDeclaringModel, \GSManager\Database\Eloquent\Relations\Pivot>
     */
     ...
     * @param  string|null  $relation
     * @param  bool  $inverse
     * @return \GSManager\Database\Eloquent\Relations\MorphToMany<TRelatedModel, $this>
     */
     ...
     * @param  string|null  $relationName
     * @param  bool  $inverse
     * @return \GSManager\Database\Eloquent\Relations\MorphToMany<TRelatedModel, TDeclaringModel>
     */
     ...
     * @param  \GSManager\Database\Eloquent\Model|null  $instance
     * @return string
     */
