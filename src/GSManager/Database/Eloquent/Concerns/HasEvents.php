...
use GSManager\Database\Eloquent\Attributes\ObservedBy;
use GSManager\Database\Eloquent\Model;
use GSManager\Events\NullDispatcher;
...
trait HasEvents
{
     ...
     *
     * @param  string  $event
     * @param  \GSManager\Events\QueuedClosure|callable|array|class-string  $callback
     * @return void
     */
