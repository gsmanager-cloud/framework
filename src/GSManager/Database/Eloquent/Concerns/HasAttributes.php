...
use GSManager\Contracts\Database\Eloquent\CastsInboundAttributes;
use GSManager\Contracts\Support\Arrayable;
use GSManager\Database\Eloquent\Casts\AsArrayObject;
use GSManager\Database\Eloquent\Casts\AsCollection;
use GSManager\Database\Eloquent\Casts\AsEncryptedArrayObject;
use GSManager\Database\Eloquent\Casts\AsEncryptedCollection;
use GSManager\Database\Eloquent\Casts\AsEnumArrayObject;
use GSManager\Database\Eloquent\Casts\AsEnumCollection;
use GSManager\Database\Eloquent\Casts\Attribute;
use GSManager\Database\Eloquent\Casts\Json;
use GSManager\Database\Eloquent\InvalidCastException;
use GSManager\Database\Eloquent\JsonEncodingException;
use GSManager\Database\Eloquent\MissingAttributeException;
use GSManager\Database\Eloquent\Relations\Relation;
use GSManager\Database\LazyLoadingViolationException;
...
use GSManager\Support\Exceptions\MathException;
...
trait HasAttributes
{
     ...
     *
     * @var \GSManager\Contracts\Encryption\Encrypter|null
     */
     ...
     * @return null
     *
     * @throws \GSManager\Database\Eloquent\MissingAttributeException
     */
     ...
     *
     * @param  \GSManager\Contracts\Encryption\Encrypter|null  $encrypter
     * @return void
     */
     ...
     * @return bool
     *
     * @throws \GSManager\Database\Eloquent\InvalidCastException
     */
