...
use Closure;
use GSManager\Database\Eloquent\Attributes\ScopedBy;
use GSManager\Database\Eloquent\Scope;
...
trait HasGlobalScopes
{
     ...
     *
     * @param  \GSManager\Database\Eloquent\Scope|(\Closure(\GSManager\Database\Eloquent\Builder<static>): mixed)|string  $scope
     * @param  \GSManager\Database\Eloquent\Scope|(\Closure(\GSManager\Database\Eloquent\Builder<static>): mixed)|null  $implementation
     * @return mixed
     *
     ...
     *
     * @param  \GSManager\Database\Eloquent\Scope|string  $scope
     * @return \GSManager\Database\Eloquent\Scope|(\Closure(\GSManager\Database\Eloquent\Builder<static>): mixed)|null
     */
