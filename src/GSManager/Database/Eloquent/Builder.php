...
use Closure;
use Exception;
use GSManager\Contracts\Database\Eloquent\Builder as BuilderContract;
use GSManager\Contracts\Database\Query\Expression;
use GSManager\Contracts\Support\Arrayable;
use GSManager\Database\Concerns\BuildsQueries;
use GSManager\Database\Eloquent\Concerns\QueriesRelationships;
use GSManager\Database\Eloquent\Relations\BelongsToMany;
use GSManager\Database\Eloquent\Relations\Relation;
use GSManager\Database\Query\Builder as QueryBuilder;
use GSManager\Database\RecordsNotFoundException;
use GSManager\Database\UniqueConstraintViolationException;
use GSManager\Pagination\Paginator;
use GSManager\Support\Arr;
use GSManager\Support\Collection as BaseCollection;
 ...
 *
 * @mixin \GSManager\Database\Query\Builder
 */
class Builder implements BuilderContract
{
    /** @use \GSManager\Database\Concerns\BuildsQueries<TModel> */
     ...
     *
     * @var \GSManager\Database\Query\Builder
     */
    protected $query;
     ...
     * @param  \GSManager\Database\Eloquent\Scope|\Closure  $scope
     * @return $this
     */
     ...
     *
     * @param  \GSManager\Database\Eloquent\Scope|string  $scope
     * @return $this
     */
     ...
     *
     * @param  (\Closure(static): mixed)|string|array|\GSManager\Contracts\Database\Query\Expression  $column
     ...
     *
     * @param  (\Closure(static): mixed)|array|string|\GSManager\Contracts\Database\Query\Expression  $column
     * @param  mixed  $operator
     * @param  mixed  $value
     * @return $this
     */
     ...
     *
     * @param  string|\GSManager\Contracts\Database\Query\Expression  $column
     * @return $this
     */
     ...
     *
     * @param  array  $items
     * @return \GSManager\Database\Eloquent\Collection<int, TModel>
     */
     ...
     * @return ($id is (\GSManager\Contracts\Support\Arrayable<array-key, mixed>|array<mixed>) ? \GSManager\Database\Eloquent\Collection<int, TModel> : TModel|null)
     */
     ...
     * @return TModel
     *
     * @throws \GSManager\Database\Eloquent\ModelNotFoundException<TModel>
     ...
     *
     * @param  \GSManager\Contracts\Support\Arrayable|array  $ids
     * @param  array|string  $columns
     * @return \GSManager\Database\Eloquent\Collection<int, TModel>
     */
     ...
     * @param  mixed  $id
     * @param  array|string  $columns
     * @return ($id is (\GSManager\Contracts\Support\Arrayable<array-key, mixed>|array<mixed>) ? \GSManager\Database\Eloquent\Collection<int, TModel> : TModel)
     *
     * @throws \GSManager\Database\Eloquent\ModelNotFoundException<TModel>
     */
     ...
     * @return (
     *     $id is (\GSManager\Contracts\Support\Arrayable<array-key, mixed>|array<mixed>)
     *     ? \GSManager\Database\Eloquent\Collection<int, TModel>
     *     : TModel|TValue
     * )
     */
     ...
     *
     * @param  string  $name
     * @return \GSManager\Database\Eloquent\Relations\Relation<\GSManager\Database\Eloquent\Model, TModel, *>
     */
     ...
     *
     * @return \GSManager\Support\LazyCollection<int, TModel>
     */
     ...
     *
     * @param  array<array-key, array|(\Closure(\GSManager\Database\Eloquent\Relations\Relation<*,*,*>): mixed)|string>|string  $relations
     * @param  (\Closure(\GSManager\Database\Eloquent\Relations\Relation<*,*,*>): mixed)|string|null  $callback
     * @return $this
     */
     ...
     *
     * @param  \GSManager\Contracts\Database\Query\Expression|array|string  $attributes
     * @param  mixed  $value
     ...
     *
     * @template TModelNew of \GSManager\Database\Eloquent\Model
     *
     ...
     *
     * @param  array|\GSManager\Contracts\Database\Query\Expression  $columns
     * @return array
     */
