...
use GSManager\Contracts\Support\CanBeEscapedWhenCastToString;
use GSManager\Contracts\Support\Jsonable;
use GSManager\Database\ConnectionResolverInterface as Resolver;
use GSManager\Database\Eloquent\Attributes\Scope as LocalScope;
use GSManager\Database\Eloquent\Attributes\UseEloquentBuilder;
...
use GSManager\Support\Stringable as SupportStringable;
...
abstract class Model implements Arrayable, ArrayAccess, CanBeEscapedWhenCastToString, HasBroadcastChannel, Jsonable, JsonSerializable, QueueableEntity, Stringable, UrlRoutable
{
    use Concerns\HasAttributes,
        ...
        ForwardsCalls;
    /** @use HasCollection<\GSManager\Database\Eloquent\Collection<array-key, static & self>> */
    use HasCollection;
     ...
     *
     * @var \GSManager\Contracts\Events\Dispatcher|null
     */
     ...
     *
     * @var class-string<\GSManager\Database\Eloquent\Builder<*>>
     */
     ...
     *
     * @var class-string<\GSManager\Database\Eloquent\Collection<*, *>>
     */
     ...
     * @return $this
     *
     * @throws \GSManager\Database\Eloquent\MassAssignmentException
     */
     ...
     * @return \GSManager\Database\Eloquent\Collection<int, static>
     */
     ...
     *
     * @param  \GSManager\Support\Collection|array|int|string  $ids
     * @return int
     */
     ...
     *
     * @param  \GSManager\Database\Eloquent\Builder<static>  $builder
     * @return \GSManager\Database\Eloquent\Builder<static>
     */
     ...
     * @return \GSManager\Database\Eloquent\Builder<*>
     */
     ...
     *
     * @return class-string<\GSManager\Database\Eloquent\Builder>|false
     */
     ...
     * @return \GSManager\Database\Eloquent\Relations\Pivot
     */
     ...
     * @return string
     *
     * @throws \GSManager\Database\Eloquent\JsonEncodingException
     */
     ...
     *
     * @param  \GSManager\Database\Eloquent\Model|null  $model
     * @return bool
     */
     ...
     *
     * @return \GSManager\Database\ConnectionResolverInterface|null
     */
     ...
     * @return \GSManager\Database\Eloquent\Model|null
     */
     ...
     * @param  mixed  $value
     * @param  string|null  $field
     * @return \GSManager\Database\Eloquent\Relations\Relation<\GSManager\Database\Eloquent\Model, $this, *>
     */
     ...
     * Retrieve the model for a bound value.
     *
     * @param  \GSManager\Database\Eloquent\Model|\GSManager\Contracts\Database\Eloquent\Builder|\GSManager\Database\Eloquent\Relations\Relation  $query
     * @param  mixed  $value
     * @param  string|null  $field
     * @return \GSManager\Contracts\Database\Eloquent\Builder
     */
