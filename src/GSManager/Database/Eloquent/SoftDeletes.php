...
/**
 * @method static \GSManager\Database\Eloquent\Builder<static> withTrashed(bool $withTrashed = true)
 * @method static \GSManager\Database\Eloquent\Builder<static> onlyTrashed()
 * @method static \GSManager\Database\Eloquent\Builder<static> withoutTrashed()
...
trait SoftDeletes
{
     ...
     *
     * @param  \GSManager\Events\QueuedClosure|callable|class-string  $callback
     * @return void
     */
