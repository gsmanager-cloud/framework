...
use GSManager\Support\Enumerable;
...
abstract class Factory
{
     ...
     * @param  \GSManager\Support\Collection|null  $states
     * @param  \GSManager\Support\Collection|null  $has
     * @param  \GSManager\Support\Collection|null  $for
     * @param  \GSManager\Support\Collection|null  $afterMaking
     * @param  \GSManager\Support\Collection|null  $afterCreating
     * @param  string|null  $connection
     * @param  \GSManager\Support\Collection|null  $recycle
     ...
     *
     * @param  (callable(array<string, mixed>): array<string, mixed>)|array<string, mixed>  $attributes
     * @param  \GSManager\Database\Eloquent\Model|null  $parent
     ...
     * @param  (callable(array<string, mixed>): array<string, mixed>)|array<string, mixed>  $attributes
     * @param  \GSManager\Database\Eloquent\Model|null  $parent
     * @return \GSManager\Database\Eloquent\Collection<int, TModel>|TModel
     */
     ...
     * @param  \GSManager\Database\Eloquent\Model|null  $parent
     * @return \Closure(): (\GSManager\Database\Eloquent\Collection<int, TModel>|TModel)
     */
     ...
     *
     * @param  \GSManager\Support\Collection<int, \GSManager\Database\Eloquent\Model>  $results
     * @return void
     */
     ...
     *
     * @param  \GSManager\Database\Eloquent\Factories\Factory|\GSManager\Database\Eloquent\Model  $factory
     * @param  string|null  $relationship
     * @return static
     */
     ...
     *
     * @param  \GSManager\Database\Eloquent\Model|\GSManager\Support\Collection|array  $model
     * @return static
     */
     ...
     *
     * @template TClass of \GSManager\Database\Eloquent\Model
     *
     ...
     *
     * @param  \Closure(TModel, \GSManager\Database\Eloquent\Model|null): mixed  $callback
     * @return static
     */
     ...
     *
     * @param  \GSManager\Support\Collection  $instances
     * @return void
     */
     ...
     * @return \GSManager\Database\Eloquent\Factories\Factory<TClass>
     */
     ...
     *
     * @param  callable(class-string<\GSManager\Database\Eloquent\Model>): class-string<\GSManager\Database\Eloquent\Factories\Factory>  $callback
     * @return void
     */
     ...
     *
     * @param  class-string<TClass>  $modelName
     * @return class-string<\GSManager\Database\Eloquent\Factories\Factory<TClass>>
     */
