...
use GSManager\Contracts\Container\BindingResolutionException;
...
use GSManager\Support\Facades\Gate;
...
class ModelInspector
{
     ...
     *
     * @param  class-string<\GSManager\Database\Eloquent\Model>|string  $model
     * @param  string|null  $connection
     * @return array{"class": class-string<\GSManager\Database\Eloquent\Model>, database: string, table: string, policy: class-string|null, attributes: \GSManager\Support\Collection, relations: \GSManager\Support\Collection, events: \GSManager\Support\Collection, observers: \GSManager\Support\Collection, collection: class-string<\GSManager\Database\Eloquent\Collection<\GSManager\Database\Eloquent\Model>>, builder: class-string<\GSManager\Database\Eloquent\Builder<\GSManager\Database\Eloquent\Model>>}
     *
    ...
    public function inspect($model, $connection = null)
    {
        ...
        /** @var \GSManager\Database\Eloquent\Model $model */
     ...
     * @return \GSManager\Support\Collection<int, array<string, mixed>>
     */
     ...
     *
     * @param  \GSManager\Database\Eloquent\Model  $model
     * @return class-string<\GSManager\Database\Eloquent\Collection>
     */
     ...
     *
     * @param  TModel  $model
     * @return class-string<\GSManager\Database\Eloquent\Builder<TModel>>
     */
     ...
     *
     * @param  string  $model
     * @return class-string<\GSManager\Database\Eloquent\Model>
     *
     * @see \GSManager\Console\GeneratorCommand
     */
