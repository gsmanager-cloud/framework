...
trait BuildsQueries
{
     ...
     *
     * @param  int  $count
     * @param  callable(\GSManager\Support\Collection<int, TValue>, int): mixed  $callback
     * @return bool
     */
     ...
     * @param  int  $count
     * @return \GSManager\Support\Collection<int, TReturn>
     */
     ...
     *
     * @param  int  $chunkSize
     * @return \GSManager\Support\LazyCollection<int, TValue>
     *
     ...
     * @param  string|null  $alias
     * @param  bool  $descending
     * @return \GSManager\Support\LazyCollection
     *
     * @throws \InvalidArgumentException
     */
     ...
     * @return TValue
     *
     * @throws \GSManager\Database\RecordNotFoundException
     */
     ...
     *
     * @param  \GSManager\Database\Query\Builder|\GSManager\Database\Eloquent\Builder<*>  $builder
     ...
     * @param  int  $currentPage
     * @param  array  $options
     * @return \GSManager\Pagination\Paginator
     */
     ...
     * @param  \GSManager\Support\Collection  $items
     * @param  int  $perPage
     * @param  \GSManager\Pagination\Cursor  $cursor
     * @param  array  $options
     * @return \GSManager\Pagination\CursorPaginator
     */
