...
abstract class Grammar
{
     ...
     *
     * @param  array<\GSManager\Contracts\Database\Query\Expression|string>  $values
     * @return array<string>
     */
     ...
     *
     * @param  \GSManager\Contracts\Database\Query\Expression|string  $value
     * @return string
     */
     ...
     *
     * @param  \GSManager\Contracts\Database\Query\Expression|string|int|float  $expression
