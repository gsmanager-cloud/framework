...
use GSManager\Database\Events\StatementPrepared;
use GSManager\Database\Events\TransactionBeginning;
use GSManager\Database\Events\TransactionCommitted;
use GSManager\Database\Events\TransactionCommitting;
use GSManager\Database\Events\TransactionRolledBack;
use GSManager\Database\Query\Builder as QueryBuilder;
use GSManager\Database\Query\Expression;
use GSManager\Database\Query\Grammars\Grammar as QueryGrammar;
use GSManager\Database\Query\Processors\Processor;
use GSManager\Database\Schema\Builder as SchemaBuilder;
...
class Connection implements ConnectionInterface
{
     ...
     *
     * @var \GSManager\Database\Schema\Grammars\Grammar
     */
     ...
     *
     * @var \GSManager\Database\DatabaseTransactionsManager|null
     */
     ...
     *
     * @return \GSManager\Database\Schema\Grammars\Grammar|null
     */
     ...
     *
     * @param  \Closure|\GSManager\Database\Query\Builder|\GSManager\Contracts\Database\Query\Expression|string  $table
     ...
     * @return mixed
     *
     * @throws \GSManager\Database\MultipleColumnsSelectedException
     */
     ...
     * @return mixed
     *
     * @throws \GSManager\Database\QueryException
     */
     ...
     *
     * @param  \GSManager\Database\QueryException  $e
     * @param  string  $query
     * @param  array  $bindings
     * @param  \Closure  $callback
     * @return mixed
     ...
     * @return mixed|false
     *
     * @throws \GSManager\Database\LostConnectionException
     */
     ...
     *
     * @param  \GSManager\Database\Query\Grammars\Grammar  $grammar
     * @return $this
     */
     ...
     *
     * @return \GSManager\Database\Schema\Grammars\Grammar
     */
     ...
     *
     * @param  \GSManager\Database\Schema\Grammars\Grammar  $grammar
     * @return $this
     */
     ...
     *
     * @param  \GSManager\Database\Query\Processors\Processor  $processor
     * @return $this
     */
     ...
     *
     * @param  \GSManager\Database\DatabaseTransactionsManager  $manager
     * @return $this
     */
