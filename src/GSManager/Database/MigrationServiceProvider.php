...
use GSManager\Database\Console\Migrations\InstallCommand;
use GSManager\Database\Console\Migrations\MigrateCommand;
use GSManager\Database\Console\Migrations\MigrateMakeCommand;
...
use GSManager\Database\Console\Migrations\StatusCommand;
use GSManager\Database\Migrations\DatabaseMigrationRepository;
use GSManager\Database\Migrations\MigrationCreator;
