...
use GSManager\Database\Eloquent\ModelInspector;
...
class ShowModelCommand extends DatabaseInspectionCommand
{
     ...
     *
     * @param  class-string<\GSManager\Database\Eloquent\Model>  $class
     * @param  string  $database
     * @param  string  $table
     * @param  class-string|null  $policy
     * @param  \GSManager\Support\Collection  $attributes
     * @param  \GSManager\Support\Collection  $relations
     * @param  \GSManager\Support\Collection  $events
     * @param  \GSManager\Support\Collection  $observers
     * @return void
     */
