...
namespace GSManager\Database\Schema\Grammars;
...
abstract class Grammar extends BaseGrammar
{
     ...
     *
     * @param  \GSManager\Database\Schema\Blueprint  $blueprint
     * @param  \GSManager\Database\Schema\ColumnDefinition  $column
     * @return string
     */
     ...
     *
     * @param  \GSManager\Support\Fluent  $column
     * @return string
     */
     ...
     * @param  \GSManager\Database\Schema\Blueprint  $blueprint
     * @param  string  $name
     * @return \GSManager\Support\Fluent|null
     */
     ...
     *
     * @param  \GSManager\Support\Fluent|\GSManager\Contracts\Database\Query\Expression|string  $value
     * @return string
     */
