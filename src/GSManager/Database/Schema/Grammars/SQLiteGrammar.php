...
use GSManager\Database\Schema\IndexDefinition;
...
class SQLiteGrammar extends Grammar
{
     ...
     *
     * @param  \GSManager\Database\Schema\ForeignKeyDefinition[]  $foreignKeys
     * @return string|null
     */
     ...
     *
     * @param  \GSManager\Support\Fluent  $foreign
     * @return string
     */
     ...
     *
     * @param  \GSManager\Support\Fluent|null  $primary
     * @return string|null
     */
