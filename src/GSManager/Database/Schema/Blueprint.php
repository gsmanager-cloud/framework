...
use GSManager\Database\Eloquent\Concerns\HasUlids;
use GSManager\Database\Query\Expression;
use GSManager\Database\Schema\Grammars\Grammar;
use GSManager\Database\Schema\Grammars\MySqlGrammar;
use GSManager\Database\Schema\Grammars\SQLiteGrammar;
...
class Blueprint
{
     ...
     *
     * @var \GSManager\Database\Schema\BlueprintState|null
     */
    protected $state;
     ...
     *
     * @deprecated Will be removed in a future GSManager version.
     *
     * @param  array  $names
     ...
     * Indicate that the given foreign key should be dropped.
     *
     * @param  \GSManager\Database\Eloquent\Model|string  $model
     ...
     *
     * @param  string  $column
     * @return \GSManager\Database\Schema\ForeignIdColumnDefinition
     */
     ...
     *
     * @param  int|null  $precision
     * @return \GSManager\Support\Collection<int, \GSManager\Database\Schema\ColumnDefinition>
     */
     ...
     *
     * @param  \GSManager\Database\Schema\ColumnDefinition  $definition
     * @return \GSManager\Database\Schema\ColumnDefinition
     */
     ...
     *
     * @return \GSManager\Database\Schema\BlueprintState
     */
