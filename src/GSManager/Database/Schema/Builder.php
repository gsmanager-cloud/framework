...
class Builder
{
     ...
     *
     * @var \Closure(string, \Closure, string): \GSManager\Database\Schema\Blueprint|null
     */
    protected $resolver;
     ...
     * @return \GSManager\Database\Schema\Blueprint
     */
     ...
     *
     * @param  \Closure(string, \Closure, string): \GSManager\Database\Schema\Blueprint|null  $resolver
     * @return void
     */
