...
use GSManager\Console\View\Components\Info;
use GSManager\Console\View\Components\Task;
use GSManager\Console\View\Components\TwoColumnDetail;
use GSManager\Contracts\Events\Dispatcher;
use GSManager\Database\ConnectionResolverInterface as Resolver;
use GSManager\Database\Events\MigrationEnded;
use GSManager\Database\Events\MigrationsEnded;
use GSManager\Database\Events\MigrationsStarted;
use GSManager\Database\Events\MigrationStarted;
use GSManager\Database\Events\NoPendingMigrations;
...
class Migrator
{
     ...
     *
     * @var \GSManager\Database\Migrations\MigrationRepositoryInterface
     */
     ...
     *
     * @var array<string, \GSManager\Database\Migrations\Migration|null>
     */
     ...
     *
     * @param  \GSManager\Database\Migrations\MigrationRepositoryInterface  $repository
     ...
     *
     * @return \GSManager\Database\Migrations\MigrationRepositoryInterface
     */
     ...
     *
     * @return \GSManager\Filesystem\Filesystem
     */
     ...
     *
     * @param  \GSManager\Contracts\Database\Events\MigrationEvent  $event
     * @return void
     */
