...
use GSManager\Database\Concerns\CompilesJsonPaths;
use GSManager\Database\Grammar as BaseGrammar;
...
class Grammar extends BaseGrammar
{
     ...
     *
     * @param  \GSManager\Database\Query\Builder  $query
     * @param  array{function: string, columns: array<\GSManager\Contracts\Database\Query\Expression|string>}  $aggregate
     * @return string
     */
    ...
    protected function compileGroupLimit(Builder $query)
    {
        ...
        $table = $this->wrap('gsmanager_table');
        $row = $this->wrap('gsmanager_row');
    ...
    protected function compileRowNumber($partition, $orders)
    {
        ...
        return ', row_number() over ('.$over.') as '.$this->wrap('gsmanager_row');
    }
