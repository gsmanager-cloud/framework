...
use GSManager\Contracts\Database\Query\Builder as BuilderContract;
use GSManager\Contracts\Database\Query\ConditionExpression;
use GSManager\Contracts\Database\Query\Expression as ExpressionContract;
use GSManager\Contracts\Support\Arrayable;
use GSManager\Database\Concerns\BuildsQueries;
use GSManager\Database\Concerns\BuildsWhereDateClauses;
use GSManager\Database\Concerns\ExplainsQueries;
use GSManager\Database\ConnectionInterface;
use GSManager\Database\Eloquent\Builder as EloquentBuilder;
use GSManager\Database\Eloquent\Relations\Relation;
use GSManager\Database\Query\Grammars\Grammar;
use GSManager\Database\Query\Processors\Processor;
use GSManager\Pagination\Paginator;
use GSManager\Support\Arr;
use GSManager\Support\Collection;
use GSManager\Support\LazyCollection;
...
{
    /** @use \GSManager\Database\Concerns\BuildsQueries<object> */
     ...
     *
     * @var \GSManager\Database\Query\Grammars\Grammar
     */
    public $grammar;
     ...
     *
     * @var \GSManager\Database\Query\Processors\Processor
     */
    public $processor;
     ...
     * @var array{
     *     function: string,
     *     columns: array<\GSManager\Contracts\Database\Query\Expression|string>
     * }|null
     */
    public $aggregate;
     ...
     *
     * @var array<string|\GSManager\Contracts\Database\Query\Expression>|null
     */
    public $columns;
     ...
     *
     * @var \GSManager\Database\Query\Expression|string
     */
    public $from;
     ...
     *
     * @var \GSManager\Database\Query\IndexHint|null
     */
    public $indexHint;
     ...
     *
     * @param  \Closure|\GSManager\Database\Query\Builder|\GSManager\Database\Eloquent\Builder<*>|string  $query
     * @param  string  $as
     * @return $this
     *
     ...
     *
     * @param  \Closure|\GSManager\Database\Query\Builder|\GSManager\Database\Eloquent\Builder<*>|\GSManager\Contracts\Database\Query\Expression|string  $table
     ...
     *
     * @param  \GSManager\Contracts\Database\Query\Expression|string  $table
     * @param  \Closure|\GSManager\Contracts\Database\Query\Expression|string  $first
     * @param  string|null  $operator
     * @param  \GSManager\Contracts\Database\Query\Expression|string|null  $second
     * @param  string  $type
     * @param  bool  $where
     * @return $this
     */
     ...
     * @param  \GSManager\Contracts\Database\Query\Expression|string  $second
     * @param  string  $type
     * @return $this
     */
     ...
     *
     * @param  \GSManager\Contracts\Database\Query\Expression|string  $table
     * @param  \Closure|\GSManager\Contracts\Database\Query\Expression|string|null  $first
     * @param  string|null  $operator
     * @param  \GSManager\Contracts\Database\Query\Expression|string|null  $second
     * @return $this
     */
     ...
     * @param  string  $type
     * @param  \GSManager\Contracts\Database\Query\Expression|string  $table
     * @return \GSManager\Database\Query\JoinClause
     */
     ...
     * @param  string  $type
     * @param  \GSManager\Contracts\Database\Query\Expression|string  $table
     * @return \GSManager\Database\Query\JoinLateralClause
     */
     ...
     *
     * @param  \Closure|string|array|\GSManager\Contracts\Database\Query\Expression  $column
     ...
     *
     * @param  \GSManager\Contracts\Database\Query\Expression|string|array  $first
     * @param  string|null  $operator
     ...
     *
     * @param  \GSManager\Contracts\Database\Query\Expression|string  $sql
     * @param  mixed  $bindings
     * @param  string  $boolean
     * @return $this
     */
     ...
     *
     * @param  \GSManager\Contracts\Database\Query\Expression|string  $column
     * @param  string  $value
     ...
     *
     * @param  string  $column
     * @param  \GSManager\Contracts\Support\Arrayable|array  $values
     * @param  string  $boolean
     * @param  bool  $not
     * @return $this
     */
     ...
     *
     * @param  string|array|\GSManager\Contracts\Database\Query\Expression  $columns
     * @param  string  $boolean
     * @param  bool  $not
     * @return $this
     */
     ...
     *
     * @param  string|array|\GSManager\Contracts\Database\Query\Expression  $column
     * @return $this
     */
     ...
     *
     * @param  \GSManager\Database\Query\Builder  $query
     * @param  string  $boolean
     * @return $this
     */
     ...
     * @param  \GSManager\Contracts\Database\Query\Expression|string  $column
     * @param  string  $operator
     * @param  \Closure|\GSManager\Database\Query\Builder|\GSManager\Database\Eloquent\Builder<*>  $callback
     * @param  string  $boolean
     * @return $this
     */
     ...
     *
     * @param  \GSManager\Contracts\Database\Query\Expression[]|\Closure[]|string[]  $columns
     * @param  mixed  $operator
     * @param  mixed  $value
     * @param  string  $boolean
     * @return $this
     ...
     *
     * @param  array|\GSManager\Contracts\Database\Query\Expression|string  ...$groups
     * @return $this
     */
     ...
     *
     * @param  \GSManager\Contracts\Database\Query\Expression|\Closure|string  $column
     * @param  \DateTimeInterface|string|int|float|null  $operator
     * @param  \GSManager\Contracts\Database\Query\Expression|\DateTimeInterface|string|int|float|null  $value
     * @param  string  $boolean
     * @return $this
     */
     ...
     *
     * @param  \Closure|\GSManager\Database\Query\Builder|\GSManager\Database\Eloquent\Builder<*>|\GSManager\Contracts\Database\Query\Expression|string  $column
     ...
     *
     * @param  \Closure|\GSManager\Database\Query\Builder|\GSManager\Contracts\Database\Query\Expression|string  $column
     * @return $this
     */
     ...
     *
     * @param  \Closure|\GSManager\Database\Query\Builder|\GSManager\Contracts\Database\Query\Expression|string|null  $column
     * @param  string  $direction
     * @return $this
     */
     ...
     *
     * @param  \Closure|\GSManager\Database\Query\Builder|\GSManager\Database\Eloquent\Builder<*>  $query
     * @param  bool  $all
     * @return $this
     */
     ...
     *
     * @param  int|string  $id
     * @param  string|\GSManager\Contracts\Database\Query\Expression|array<string|\GSManager\Contracts\Database\Query\Expression>  $columns
     * @return object|null
     */
     ...
     *
     * @param  mixed  $id
     * @param  (\Closure(): TValue)|string|\GSManager\Contracts\Database\Query\Expression|array<string|\GSManager\Contracts\Database\Query\Expression>  $columns
     ...
     * @return mixed
     *
     * @throws \GSManager\Database\RecordsNotFoundException
     * @throws \GSManager\Database\MultipleRecordsFoundException
     */
     ...
     *
     * @param  string|\GSManager\Contracts\Database\Query\Expression|array<string|\GSManager\Contracts\Database\Query\Expression>  $columns
     * @return \GSManager\Support\Collection<int, \stdClass>
     */
     ...
     *
     * @param  \GSManager\Support\Collection  $items
     * @return \GSManager\Support\Collection
     */
    protected function withoutGroupLimitKeys($items)
    {
        $keysToRemove = ['gsmanager_row'];

        if (is_string($this->groupLimit['column'])) {
            $column = last(explode('.', $this->groupLimit['column']));

            $keysToRemove[] = '@gsmanager_group := '.$this->grammar->wrap($column);
            $keysToRemove[] = '@gsmanager_group := '.$this->grammar->wrap('pivot_'.$column);
        }
     ...
     * @return \GSManager\Pagination\LengthAwarePaginator
     */
     ...
     * @param  string  $pageName
     * @param  int|null  $page
     * @return \GSManager\Contracts\Pagination\Paginator
     */
     ...
     * @param  \GSManager\Pagination\Cursor|string|null  $cursor
     * @return \GSManager\Contracts\Pagination\CursorPaginator
     */
     ...
     *
     * @param  array<string|\GSManager\Contracts\Database\Query\Expression>  $columns
     * @return int<0, max>
     */
     ...
     *
     * @param  array<string|\GSManager\Contracts\Database\Query\Expression>  $columns
     * @return array<string|\GSManager\Contracts\Database\Query\Expression>
     */
     ...
     *
     * @return \GSManager\Support\LazyCollection<int, \stdClass>
     */
     ...
     * @return \GSManager\Support\Collection<array-key, mixed>
     */
     ...
     *
     * @param  \GSManager\Contracts\Database\Query\Expression|string  $columns
     * @return int<0, max>
     */
     ...
     *
     * @param  string  $function
     * @param  array<\GSManager\Contracts\Database\Query\Expression|string>  $columns
     * @return $this
     */
     ...
     *
     * @param  mixed  $value
     * @return \GSManager\Contracts\Database\Query\Expression
     */
     ...
     *
     * @return \GSManager\Database\Query\Processors\Processor
     */
     ...
     *
     * @return \GSManager\Database\Query\Grammars\Grammar
     */
