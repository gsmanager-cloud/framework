...
namespace GSManager\Database\Connectors;

use GSManager\Contracts\Container\Container;
use GSManager\Database\Connection;
use GSManager\Database\MariaDbConnection;
use GSManager\Database\MySqlConnection;
...
class ConnectionFactory
{
     ...
     *
     * @param  array  $config
     * @return \GSManager\Database\Connectors\ConnectorInterface
     *
     * @throws \InvalidArgumentException
     */
